...
> **Hermes install note:** On this machine, run scripts with the skill-bundled venv —
> `/opt/data/skills/seo/.venv/bin/python3` — which has `requests`, `beautifulsoup4`,
> `lxml` pre-installed. Plain `python3`/`pip` may be PEP-668 managed and lack these.
