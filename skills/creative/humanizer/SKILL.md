...
A user-provided writing sample overrides this rule if it uses tailing negations at similar frequency; match the sample instead of scrubbing every instance.
