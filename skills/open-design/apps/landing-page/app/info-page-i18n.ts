...
export type AgentGuideCopy = {
  ...
  // "With OpenDesign" — the drive-to-OD section
  withOdTitle: string;
  withOdLead: string;
  withOdSteps: string[];
...
const INFO_PAGE_COPY: Partial<Record<LandingLocaleCode, InfoPageCopy>> = {
  en: {
    ...
    official: {
      ...
      description:
        'Official source page for OpenDesign (also searched as Open Design, open-design, opendesign, Open Design AI, OD). Canonical site, GitHub repository, releases, Discord, license, and maintainer identity in one place.',
      breadcrumb: 'Official',
      label: 'Source · Nº 00',
      heading: 'Official OpenDesign source page.',
      lead:
        'OpenDesign (also searched as Open Design, open-design, opendesign, or Open Design AI) is the official open-source AI design workspace from the nexu-io/open-design project. This page lists every canonical surface so you can verify the source for yourself.',
      ...
      aliases: [
        { label: 'OpenDesign', body: 'canonical one-word display name in the product UI, blog, and READMEs.' },
        { label: 'Open Design', body: 'legacy two-word spelling; still a common search variant for the same project.' },
      ...
      maintainerBody:
        'OpenDesign is developed in the open at github.com/nexu-io/open-design and released under the Apache-2.0 license. Issues, RFCs, and roadmap conversations happen on GitHub Issues and Discord.',
    ...
    quickstart: {
      title: 'OpenDesign quickstart — Install in three commands (Node 24, pnpm)',
      description:
        'Install OpenDesign locally with three commands. Requirements (Node 24, pnpm 10.33.2), commands, expected output, troubleshooting, and how to generate your first design artifact with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen.',
      breadcrumb: 'Quickstart',
      label: 'Install · Nº 01',
      heading: 'OpenDesign quickstart.',
      lead:
        'OpenDesign runs entirely on your machine. Three commands gets you from a clean checkout to a running daemon, web UI, and your first generated design artifact.',
      ...
      nextItems: [
        ...
        { label: 'Compare OpenDesign', body: 'with Claude Design, Figma Make, v0, and Lovable.' },
    ...
    agents: {
      title: 'OpenDesign agents — {count} BYOK adapters',
      description:
        'OpenDesign ships {count} BYOK adapters out of the box. Drive design from the same agent you use for code — no separate vendor login.',
      breadcrumb: 'Agents',
      label: 'Adapters · Nº 04',
      heading: (count) => `${count} BYOK agents, one skill protocol.`,
      lead: (count) =>
        `OpenDesign ships ${count} first-party adapters out of the box. The same composable skills and portable DESIGN.md systems work with every one. BYOK throughout — your keys, your spend, your data.`,
      adaptersTitle: 'How adapters plug in',
      adaptersBody:
        'Every adapter is a thin shim between the agent native message format and OpenDesign skill protocol. Adding a new adapter is a single file — no fork required.',
      tiers: [
        {
          label: 'Tier 1 — first-party tested',
          blurb:
            'Battle-tested daily by the OpenDesign maintainers. Stream-JSON IPC where supported, full AskUserQuestion mid-turn, skill-aware system prompts.',
        },
        {
      ...
      byokLead: 'BYOK ("bring your own key") in OpenDesign keeps credentials and spend on your side:',
      byokItems: [
      ...
      ctaBody:
        'Pick the agent already on your laptop, point OpenDesign at it, and start rendering.',
    },
    compare: {
      title: 'OpenDesign vs Figma, Lovable, Bolt, v0, Framer — honest comparisons',
      description:
        'Compare OpenDesign to the major AI design and app-building tools. Hosted vs local-first, BYOK vs vendor-locked, single-shot generation vs portable DESIGN.md systems.',
      breadcrumb: 'Compare',
      label: 'Evaluation · Nº 02',
      heading: 'OpenDesign vs everything else.',
      lead:
      ...
      comparisons: [
        {
          ...
          summary:
            'Hosted product tied to a single vendor. OpenDesign is local-first, BYOK, and Apache-2.0 — your skills and DESIGN.md live in your repo.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Figma',
          summary:
            'Figma is a hosted, hands-on design canvas. OpenDesign is agent-driven and local-first, with your brand and artifacts as files in your repo.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Lovable',
          summary:
            'Lovable ships hosted prompt-to-app builds. OpenDesign is the design-first, BYOK layer for the coding agent you already use.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Bolt',
          summary:
            'Bolt builds running full-stack apps in the browser. OpenDesign produces design artifacts you own, locally, with your own agent.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'v0',
          summary:
            'v0 generates hosted UI tuned for the Vercel and React stack. OpenDesign generates design with any agent, locally, as files you own.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Framer',
          summary:
            'Framer is a hosted no-code site builder. OpenDesign is the open-source, agent-driven alternative that keeps design as files you deploy anywhere.',
          cta: 'Read the full comparison ->',
        },
      ],
      limitsTitle: "Honest limits — what OpenDesign isn't",
      limitsBody:
      ...
      limitsFaq: [
        { name: 'Does OpenDesign offer a hosted web sandbox?', text: 'No. OpenDesign is local-first by design.' },
        { name: 'Can I use OpenDesign without installing anything?', text: 'Not today. The minimum is a local daemon plus a coding agent.' },
        { name: 'Is OpenDesign a v0 / Lovable / Bolt replacement?', text: 'It depends. OpenDesign focuses on prompt-to-design-artifact via a skill protocol you can fork.' },
        { name: 'Does OpenDesign send my data to Anthropic, OpenAI, or Google?', text: 'Only your prompt and skill context goes to the provider whose key you brought.' },
        { name: 'Can I self-host OpenDesign on my own infrastructure?', text: 'Yes. Apache-2.0 license, Node 24 daemon, no required SaaS.' },
      ],
    },
    claudeAlternative: {
      title: 'Open-source Claude Design alternative — OpenDesign (BYOK, local-first)',
      description:
        'OpenDesign is the open-source, local-first alternative to Claude Design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen.',
      breadcrumb: 'Open-source Claude Design alternative',
      label: 'Alternative · Nº 03',
      heading: 'Open-source Claude Design alternative.',
      lead:
        'OpenDesign is the official open-source, local-first alternative to Claude Design. BYOK with the agent you already use, keep your brand as a portable DESIGN.md file, and ship artifacts as files in your project.',
      tldrTitle: 'TL;DR',
      tldrBody:
      ...
      localByokBody: [
        'OpenDesign runs a desktop app, a local daemon, and Markdown skill/system catalogs on your machine.',
      ...
      pickOpenTitle: 'Pick OpenDesign if',
      pickOpen: [
      ...
      migrateSteps: [
        'Install OpenDesign from the quickstart.',
      ...
      faqTitle: 'FAQ',
      faq: [
        { name: 'Is OpenDesign really a drop-in alternative to Claude Design?', text: 'Not literally, but they overlap on prompt-to-design-artifact use cases.' },
        { name: 'Can I use Claude as my agent in OpenDesign?', text: 'Yes. OpenDesign supports Claude Code and Anthropic API BYOK flows.' },
        { name: 'What happens to my Claude Design designs?', text: 'You can keep using Claude Design alongside OpenDesign; migration is manual today.' },
        { name: 'Does OpenDesign generate the same artifact types?', text: 'Yes for common types: landing pages, decks, dashboards, social posts, brand systems, and prototypes.' },
        ...
        { name: 'Who builds and maintains OpenDesign?', text: 'The project lives at github.com/nexu-io/open-design and is Apache-2.0.' },
      ],
    ...
    alternatives: {
      lovable: {
        title: 'Open-source Lovable alternative — OpenDesign (design-first, BYOK, local)',
        description:
          'OpenDesign is the open-source, local-first alternative to Lovable for design-first work. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — artifacts ship as files in your repo.',
        breadcrumb: 'Open-source Lovable alternative',
        label: 'Alternative · Lovable',
        heading: 'Open-source Lovable alternative.',
        lead:
          'Lovable turns a prompt into a deployed full-stack app. OpenDesign is a self-evolving design agent for Claude Code — local-first, BYOK, open source — focused on design artifacts and a portable brand rather than shipping the backend. Different primary job, overlapping prompt-to-UI surface.',
        tldrTitle: 'TL;DR',
        tldrBody:
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'OpenDesign runs a desktop app, a local daemon, and Markdown skill/system catalogs on your machine — no design output is forced through a vendor cloud.',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is OpenDesign a drop-in replacement for Lovable?', text: 'No. Lovable ships deployed full-stack apps; OpenDesign is design-first and produces artifacts you own. They overlap on prompt-to-UI, not on hosting a backend.' },
          { name: 'Can OpenDesign build a full app like Lovable?', text: 'OpenDesign focuses on design artifacts, prototypes, and brand systems. For production backends and one-click hosting, Lovable is the better fit.' },
          { name: 'Which agent does OpenDesign use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account.' },
          { name: 'Is OpenDesign really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Can I keep using Lovable alongside OpenDesign?', text: 'Yes. Many teams prototype design in OpenDesign and ship apps in Lovable; migration is manual today.' },
        ...
        rich: {
          heroCtaLead:
            'OpenDesign is the open-source, local-first design layer around the coding agent you already use — your key, your files, a curated skill and design-system library.',
          heroCtaActions: [
            { label: 'Download OpenDesign', href: '/download/', variant: 'primary' },
          ...
          heroImage: {
            ...
            alt: 'OpenDesign vs Lovable — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Lovable turns a prompt into a deployed full-stack app. OpenDesign is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — focused on producing design artifacts and a portable brand you keep as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                { kind: 'p', text: 'Looking for a Lovable alternative? The best Lovable alternatives are OpenDesign (open-source, local-first), Bolt, v0, Cursor, Replit, and Dyad — here is how they compare and where each one fits. OpenDesign is the pick if you want to own your design artifacts as version-controlled files instead of state inside a hosted app-builder.' },
                { kind: 'table', columns: ['Tool', 'License', 'Pricing', 'Best for', 'Open source'], rows: [
                  ['OpenDesign', 'Apache-2.0', 'Free app · BYOK (pay your own API)', 'Design-first artifacts you own as files', 'Yes'],
                ...
                { kind: 'steps', items: [
                  { label: 'OpenDesign', body: 'The open-source, local-first, design-first pick — #1 for people who want to own their design artifacts as files, not a Lovable clone. Apache-2.0, BYOK, drives the coding agent you already use. Best for design artifacts and a portable brand you keep in your own repo.' },
                ...
                { kind: 'p', text: 'Where OpenDesign fits honestly: it is a design layer around the coding agent you already use — BYOK, Apache-2.0 — so it is the Lovable alternative for people who want design artifacts as version-controlled files rather than a hosted app-builder. If you specifically want a hosted prompt-to-app builder, Lovable, Bolt, or Replit fit better.' },
              ],
            },
            {
              id: 'free-oss',
              ...
              blocks: [
                { kind: 'p', text: 'Yes. OpenDesign is free and open-source — Apache-2.0, BYOK, so the app costs nothing and you pay only your own provider API spend — and is the design-first option. Dyad (Apache-2.0) is the other open-source option: a local app builder you can run for free. Both are free to run, and between them they cover the two high-intent needs behind "free open-source Lovable alternative": design-first artifact ownership (OpenDesign) and a self-hostable app builder (Dyad).' },
              ],
            },
            {
              id: 'what-is-lovable',
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and runs in the vendor cloud, billed by subscription and per-message credits. That is a different posture from OpenDesign, which is a local-first, open-source design agent you point your own coding agent at — and the two overlap on prompt-to-UI, not on hosting a backend.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              blocks: [
                { kind: 'p', text: 'OpenDesign runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. No design output is forced through a vendor cloud, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — OpenDesign never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'OpenDesign vs Lovable, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'OpenDesign', 'Lovable'], rows: [
                ...
                { kind: 'p', text: 'Where Lovable wins: if your goal is a deployed, hosted full-stack app with the backend wired up for you, Lovable does that out of the box and OpenDesign does not. OpenDesign is design-first.' },
              ],
            },
            {
              id: 'who-picks',
              ...
              blocks: [
                ...
                { kind: 'p', text: 'Pick OpenDesign if:' },
                { kind: 'ul', items: [
                  'You want design artifacts and a brand as version-controlled files.',
                  'You want BYOK with your existing coding agent.',
                  'You want open source you can fork, rebrand, embed in CLI, or self-host.',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Lovable into OpenDesign',
              blocks: [
          ...
          faq: [
            { name: 'Is OpenDesign a drop-in replacement for Lovable?', text: 'No. Lovable ships deployed full-stack apps; OpenDesign is design-first and produces artifacts you own. They overlap on prompt-to-UI, not on hosting a backend.' },
            { name: 'What is the best free Lovable alternative?', text: 'OpenDesign — it is free and open-source (Apache-2.0, BYOK, so you pay only your own API spend) and is the strongest pick for design-first work. If you specifically want a local open-source app builder instead, Dyad (Apache-2.0) is free to run.' },
            { name: 'Is there an open-source Lovable alternative?', text: 'Yes — OpenDesign is an open-source, local-first alternative focused on design artifacts (Apache-2.0, agent-native), and Dyad is an open-source local app builder (Apache-2.0). Both are free to run.' },
            { name: 'Lovable vs Bolt vs v0 — which should I use?', text: 'Lovable is aimed at non-technical makers building full apps from a prompt; Bolt (bolt.new) builds a full-stack app in the browser; v0 (Vercel) generates React/Next.js UI and components. Pick OpenDesign when you want to own your design artifacts as version-controlled files rather than state inside a hosted builder.' },
            { name: 'Can OpenDesign build a full app like Lovable?', text: 'OpenDesign focuses on design artifacts, prototypes, and brand systems. For production backends and one-click hosting, Lovable is the better fit.' },
            { name: 'Which agent does OpenDesign use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account and credentials are never proxied through us.' },
            { name: 'Is OpenDesign really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
            { name: 'Can I keep using Lovable alongside OpenDesign?', text: 'Yes. Many teams prototype design in OpenDesign and ship apps in Lovable; migration is manual today.' },
            { name: 'Is OpenDesign affiliated with Lovable?', text: 'No. OpenDesign is an independent, open-source project. Lovable is a trademark of its owner; this is an unaffiliated comparison.' },
          ],
          ctaTitle: 'Design-first, in three commands.',
          ctaBody:
            'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
      ...
      figma: {
        title: 'Open-source Figma alternative — OpenDesign (design-first, BYOK, local)',
        description:
          'OpenDesign is the open-source, local-first alternative to Figma for agent-driven design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — your brand and artifacts live as files in your repo.',
        breadcrumb: 'Open-source Figma alternative',
        label: 'Alternative · Figma',
        heading: 'Open-source Figma alternative.',
        lead:
          'Figma is a hosted, collaborative canvas you design on by hand. OpenDesign is a self-evolving design agent for Claude Code — local-first, BYOK, Apache-2.0 — where you drive design through your coding agent and keep a portable brand as files. Different shape, same goal: shipped interfaces.',
        tldrTitle: 'TL;DR',
        tldrBody:
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'OpenDesign runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine — your designs are files, not cloud documents.',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is OpenDesign a drop-in replacement for Figma?', text: 'No. Figma is a hands-on collaborative canvas; OpenDesign is an agent-driven, local-first design layer. They overlap on producing interfaces, not on real-time canvas editing.' },
          { name: 'Can I still use Figma alongside OpenDesign?', text: 'Yes. Many teams design in Figma and use OpenDesign to generate and iterate from a portable brand; migration is manual today.' },
          { name: 'Which agent does OpenDesign use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. Credentials are never proxied through us.' },
          { name: 'Is OpenDesign really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is OpenDesign affiliated with Figma?', text: 'No. OpenDesign is an independent, open-source project. Figma is a trademark of its owner; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Design-first, in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'OpenDesign vs Figma — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Figma turns a cloud canvas into shared, hands-on interface design. OpenDesign is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — where you drive design through your agent and keep a portable brand as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                { kind: 'p', text: 'The best Figma alternatives are Penpot, OpenDesign, Lunacy, Pixso, and OpenPencil — with Penpot and OpenDesign leading on the open-source, free-to-use angle. Here is how they compare and where each fits.' },
                { kind: 'table', columns: ['Tool', 'License', 'Pricing', 'Best for', 'Open source'], rows: [
                  ['Penpot', 'Open source (MPL-2.0)', 'Free, self-host', 'Open-source design & prototyping canvas', 'Yes'],
                  ['OpenDesign', 'Apache-2.0', 'Free app · BYOK (pay your own API)', 'Agent-native design artifacts you own as files', 'Yes'],
                ...
                { kind: 'steps', items: [
                  ...
                  { label: 'OpenDesign', body: 'The agent-native, local-first pick — for people who want design artifacts as version-controlled files driven by the coding agent they already use, not a Figma-canvas clone. Apache-2.0, BYOK. Best for owning your design output as files in your own repo.' },
                ...
                { kind: 'p', text: 'Where OpenDesign fits honestly: it is a design layer around the coding agent you already use — BYOK, Apache-2.0 — a different job from a canvas editor. It is for owning your design output as files, not pixel-pushing on a shared canvas. If you specifically want an open-source Figma-style canvas, Penpot is the closest replacement.' },
              ],
            },
            {
              id: 'free-oss',
              ...
              blocks: [
                { kind: 'p', text: 'Figma is proprietary and closed-source. If you want an open-source alternative you can self-host, Penpot (MPL-2.0) is the closest canvas replacement and OpenDesign (Apache-2.0) is the agent-native, local-first option; both are free to use.' },
              ],
            },
            {
              id: 'what-is-figma',
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and runs in the vendor cloud, billed per editor seat. OpenDesign is a different shape: a local-first, open-source design agent you point your own coding agent at — the two overlap on producing interfaces, not on real-time canvas editing.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'p', text: 'OpenDesign runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. Your designs are files, not cloud documents, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — OpenDesign never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'OpenDesign vs Figma, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'OpenDesign', 'Figma'], rows: [
                ...
                { kind: 'p', text: 'Where Figma wins: hands-on vector editing, a real-time multiplayer canvas, and a deep, mature plugin and component ecosystem. If that hands-on canvas is the job, Figma is hard to beat — OpenDesign is design-first and agent-driven instead.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Figma into OpenDesign',
              blocks: [
          ...
          faq: [
            { name: 'Is OpenDesign a drop-in replacement for Figma?', text: 'No. Figma is a hands-on collaborative canvas; OpenDesign is an agent-driven, local-first design layer. They overlap on producing interfaces, not on real-time canvas editing.' },
            { name: 'What are the best free Figma alternatives?', text: 'Penpot and OpenDesign are free and open-source; Lunacy is a free proprietary option.' },
            { name: 'Is Figma open source?', text: 'No, Figma is proprietary/closed-source; Penpot and OpenDesign are open-source alternatives.' },
            { name: 'Is there an open-source Figma alternative?', text: 'Yes — Penpot (MPL-2.0) as a canvas replacement, OpenDesign (Apache-2.0) as an agent-native design layer, OpenPencil (MIT) as an AI-native .fig-reading option.' },
            { name: 'Can I still use Figma alongside OpenDesign?', text: 'Yes. Many teams design in Figma and use OpenDesign to generate and iterate from a portable brand; migration is manual today.' },
            { name: 'Which agent does OpenDesign use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. Credentials are never proxied through us.' },
            { name: 'Is OpenDesign really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
            { name: 'Is OpenDesign affiliated with Figma?', text: 'No. OpenDesign is an independent, open-source project. Figma is a trademark of its owner; this is an unaffiliated comparison.' },
      ...
      bolt: {
        title: 'Open-source Bolt alternative — OpenDesign (design-first, BYOK, local)',
        description:
          'OpenDesign is the open-source, local-first alternative to Bolt (bolt.new) for design-first work. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — artifacts ship as files in your repo.',
        breadcrumb: 'Open-source Bolt alternative',
        label: 'Alternative · Bolt',
        heading: 'Open-source Bolt alternative.',
        lead:
          'Bolt (bolt.new) turns a prompt into a running full-stack app in the browser. OpenDesign is a self-evolving design agent for Claude Code — local-first, BYOK, open source — focused on design artifacts and a portable brand rather than shipping the backend. Different primary job, overlapping prompt-to-UI surface.',
        tldrTitle: 'TL;DR',
        tldrBody:
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'OpenDesign runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine — no design output is forced through a vendor cloud.',
          'You bring your own agent key; credentials stay local and never proxy through us, and API spend bills to you.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is OpenDesign a drop-in replacement for Bolt?', text: 'No. Bolt ships running full-stack apps; OpenDesign is design-first and produces artifacts you own. They overlap on prompt-to-UI, not on running a backend.' },
          { name: 'Can OpenDesign build a full app like Bolt?', text: 'OpenDesign focuses on design artifacts, prototypes, and brand systems. For an instant in-browser full-stack app, Bolt is the better fit.' },
          { name: 'Which agent does OpenDesign use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account and credentials are never proxied through us.' },
          { name: 'Is OpenDesign really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is OpenDesign affiliated with Bolt?', text: 'No. OpenDesign is an independent, open-source project. Bolt and bolt.new are trademarks of their owner; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Design-first, in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'OpenDesign vs Bolt — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Bolt turns a prompt into a running full-stack app in the browser. OpenDesign is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — focused on producing design artifacts and a portable brand you keep as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                { kind: 'p', text: 'The best bolt.new alternatives are OpenDesign (open-source, local-first), Lovable, v0, Cursor, Replit, and the community fork OpenBolt — here is how they compare and where each one fits. OpenDesign is the pick if you want to own your design artifacts as version-controlled files instead of state inside a hosted app-builder.' },
                { kind: 'table', columns: ['Tool', 'License', 'Pricing', 'Best for', 'Open source'], rows: [
                  ['OpenDesign', 'Apache-2.0', 'Free app · BYOK (pay your own API)', 'Design-first artifacts you own as files', 'Yes'],
                ...
                { kind: 'steps', items: [
                  { label: 'OpenDesign', body: 'The open-source, local-first, design-first pick — #1 for people who want to own their design artifacts as files, not a bolt.new clone. Apache-2.0, BYOK, drives the coding agent you already use. Best for design artifacts and a portable brand you keep in your own repo.' },
                ...
                { kind: 'p', text: 'Where OpenDesign fits honestly: it is a design layer around the coding agent you already use — BYOK, Apache-2.0 — so it is the bolt.new alternative for people who want design artifacts as version-controlled files rather than a hosted app-builder. If you specifically want a hosted prompt-to-app builder, Lovable, Replit, or bolt.new itself fit better.' },
              ],
            },
            {
              id: 'free-oss',
              ...
              blocks: [
                { kind: 'p', text: 'Yes. OpenDesign is free and open-source — Apache-2.0, BYOK, so the app costs nothing and you pay only your own provider API spend. For the bolt.new experience itself as open source, OpenBolt (bolt.diy) is the community OSS fork of bolt.new you can self-host. Between them they cover the two high-intent needs behind "free open-source bolt.new alternative": design-first artifact ownership (OpenDesign) and a self-hostable app builder (OpenBolt).' },
              ],
            },
            {
              id: 'what-is-bolt',
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and hosted, billed by subscription and per-token credits. OpenDesign is a different posture: a local-first, open-source design agent you point your own coding agent at — and the two overlap on prompt-to-UI, not on running a backend.' },
                { kind: 'ul', items: [
            ...
            {
              id: 'compare',
              heading: 'OpenDesign vs Bolt, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'OpenDesign', 'Bolt'], rows: [
                ...
                { kind: 'p', text: 'Where Bolt wins: if your goal is an instant, running full-stack app in the browser with the dev environment wired up for you, Bolt does that out of the box. OpenDesign is design-first.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Bolt into OpenDesign',
              blocks: [
          ...
          faq: [
            { name: 'Is OpenDesign a drop-in replacement for Bolt?', text: 'No. Bolt ships running full-stack apps; OpenDesign is design-first and produces artifacts you own. They overlap on prompt-to-UI, not on running a backend.' },
            { name: 'What is the best free bolt.new alternative?', text: 'OpenDesign — it is free and open-source (Apache-2.0, BYOK, so you pay only your own API spend) and is the strongest pick for design-first work. If you specifically want the bolt.new experience itself as open source, OpenBolt (bolt.diy) lets you self-host it for free.' },
            { name: 'Is there an open-source bolt.new?', text: 'bolt.new itself is proprietary, but OpenBolt (bolt.diy) is the community open-source fork you can self-host. OpenDesign is a separate open-source, local-first alternative focused on design artifacts rather than a hosted app builder.' },
            { name: 'bolt.new vs Lovable vs v0 — which should I use?', text: 'bolt.new builds a full-stack app in the browser from a prompt; Lovable is aimed at non-technical makers building full apps; v0 (Vercel) generates React/Next.js UI and components. Pick OpenDesign when you want to own your design artifacts as version-controlled files rather than state inside a hosted builder.' },
            { name: 'Can OpenDesign build a full app like Bolt?', text: 'OpenDesign focuses on design artifacts, prototypes, and brand systems. For an instant in-browser full-stack app, Bolt is the better fit.' },
            { name: 'Which agent does OpenDesign use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account and credentials are never proxied through us.' },
            { name: 'Is OpenDesign really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
            { name: 'Is OpenDesign affiliated with Bolt?', text: 'No. OpenDesign is an independent, open-source project. Bolt and bolt.new are trademarks of their owner; this is an unaffiliated comparison.' },
      ...
      v0: {
        title: 'Open-source v0 alternative — OpenDesign (design-first, BYOK, local)',
        description:
          'OpenDesign is the open-source, local-first alternative to v0 by Vercel for design-first work. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — artifacts ship as files in your repo.',
        breadcrumb: 'Open-source v0 alternative',
        label: 'Alternative · v0',
        heading: 'Open-source v0 alternative.',
        lead:
          'v0 by Vercel turns a prompt into hosted UI components. OpenDesign is a self-evolving design agent for Claude Code — local-first, BYOK, open source — that drives any coding agent and keeps your brand and artifacts as files. Closest overlap of the bunch: prompt-to-UI, different posture.',
        tldrTitle: 'TL;DR',
        tldrBody:
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'OpenDesign runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine — your UI is files, not hosted generations.',
          'You bring your own agent key; credentials stay local and never proxy through us, and API spend bills to you.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is OpenDesign a drop-in replacement for v0?', text: 'No. v0 generates UI in Vercel’s hosted flow; OpenDesign is design-first and produces artifacts you own with any agent. They overlap on prompt-to-UI, not on the Vercel-hosted pipeline.' },
          { name: 'Does OpenDesign lock me to a stack?', text: 'No. BYOK with any supported agent, and your output is plain files in your repo — not tied to one framework or host.' },
          { name: 'Which agent does OpenDesign use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account and credentials are never proxied through us.' },
          { name: 'Is OpenDesign really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is OpenDesign affiliated with v0 or Vercel?', text: 'No. OpenDesign is an independent, open-source project. v0 and Vercel are trademarks of their owner; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Design-first, in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'OpenDesign vs v0 — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'v0 by Vercel turns a prompt into hosted UI components, tuned for the React and Vercel ecosystem. OpenDesign is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — focused on producing design artifacts and a portable brand you keep as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and runs in the vendor cloud, billed by subscription and per-generation credits. OpenDesign is a different posture: a local-first, open-source design agent you point your own coding agent at — overlapping on prompt-to-UI, not on the Vercel-hosted pipeline.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'p', text: 'OpenDesign runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. Your UI is files, not hosted generations, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — OpenDesign never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'OpenDesign vs v0, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'OpenDesign', 'v0'], rows: [
                ...
                { kind: 'p', text: 'Where v0 wins: if you live in the Vercel, Next.js and React ecosystem and want UI generated and deployed in one tight hosted flow, v0 is built for exactly that. OpenDesign is design-first and stack-agnostic.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from v0 into OpenDesign',
              blocks: [
      ...
      framer: {
        title: 'Open-source Framer alternative — OpenDesign (design-first, BYOK, local)',
        description:
          'OpenDesign is the open-source, local-first alternative to Framer for agent-driven design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — your brand and artifacts live as files in your repo.',
        breadcrumb: 'Open-source Framer alternative',
        label: 'Alternative · Framer',
        heading: 'Open-source Framer alternative.',
        lead:
          'Framer is a hosted, no-code visual builder for designing and publishing sites. OpenDesign is a self-evolving design agent for Claude Code — local-first, BYOK, open source — where you drive design through your coding agent and keep a portable brand as files. Different shape, same goal: shipped interfaces.',
        tldrTitle: 'TL;DR',
        tldrBody:
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'OpenDesign runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine — your designs are files, not a hosted project.',
          'You bring your own agent key; credentials stay local and never proxy through us, and API spend bills to you.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is OpenDesign a drop-in replacement for Framer?', text: 'No. Framer is a hosted no-code site builder; OpenDesign is an agent-driven, local-first design layer. They overlap on producing interfaces, not on no-code publishing and hosting.' },
          { name: 'Can OpenDesign publish a site like Framer?', text: 'OpenDesign produces design artifacts and code you own; you deploy them yourself. For an all-in-one no-code builder plus hosting, Framer is the better fit.' },
          { name: 'Which agent does OpenDesign use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. Credentials are never proxied through us.' },
          { name: 'Is OpenDesign really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is OpenDesign affiliated with Framer?', text: 'No. OpenDesign is an independent, open-source project. Framer is a trademark of its owner; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Design-first, in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'OpenDesign vs Framer — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Framer turns a hosted, no-code canvas into designed and published websites. OpenDesign is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — where you drive design through your agent and keep a portable brand as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and runs in the vendor cloud, billed by subscription. OpenDesign is a different posture: a local-first, open-source design agent you point your own coding agent at — overlapping on producing interfaces, not on no-code publishing and hosting.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'p', text: 'OpenDesign runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. Your designs are files, not a hosted project, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — OpenDesign never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'OpenDesign vs Framer, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'OpenDesign', 'Framer'], rows: [
                ...
                { kind: 'p', text: 'Where Framer wins: if you want a no-code visual builder that designs and publishes a marketing site with hosting included, Framer does that end to end. OpenDesign is design-first and agent-driven instead.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Framer into OpenDesign',
              blocks: [
      ...
      stitch: {
        title: 'Best Google Stitch alternative for design — OpenDesign',
        description:
          'Google Stitch is a free Gemini-powered UI generator from Google Labs, capped at ~350 standard generations/month in a hosted canvas. OpenDesign is the open-source, local-first alternative — BYOK, no Google account, design system as files you own.',
        ...
        lead:
          'Google Stitch turns a prompt into a polished, Gemini-generated UI inside a hosted Google Labs canvas — free, but capped at ~350 standard generations a month and tied to a Google account. OpenDesign is a local-first, open-source design agent you point your own coding agent at: same prompt-to-UI surface, but the source, the design system, and the output stay as files you own.',
        tldrTitle: 'TL;DR',
        tldrBody:
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'OpenDesign runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your own machine — no design output is forced through a vendor cloud, and your brand lives in your repo as a portable DESIGN.md file every skill respects. There is no monthly generation cap baked into the product.',
          'You bring your own agent key — Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. Credentials stay in local config or environment variables (OpenDesign never proxies them), model spend bills directly to your provider account, and you can drive everything from the od CLI or the local HTTP daemon, not just a web UI.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        migrateSteps: [
          'Install OpenDesign from the download page and bring your own agent key (Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen).',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'What are Google Stitch’s generation limits?', text: 'Stitch’s free tier runs roughly 350 standard generations per month on Gemini 2.5 Flash, plus a smaller experimental pool on Gemini 2.5 Pro (commonly reported around 50). Reports through 2026 show the cap shifting and sometimes resetting daily; either way there is no paid tier to raise it and no bring-your-own-key option. OpenDesign has no app-level cap — you pay your own model API spend.' },
          { name: 'Is Google Stitch free?', text: 'Yes. Stitch is a free Google Labs experiment with no subscription, but it requires a Google account and the work lives in Google’s cloud. OpenDesign is also free and open source (Apache-2.0); you bring your own agent key, so model spend bills to you with no vendor cap.' },
          { name: 'Can I self-host an alternative to Google Stitch?', text: 'Stitch is cloud-only and closed-source — there is no self-host option. OpenDesign runs locally and self-hosts anywhere Node 24 runs, with full source on GitHub under Apache-2.0.' },
          { name: 'How does export compare?', text: 'Stitch exports HTML/CSS and React and supports paste-into-Figma (auto-layout, named layers, editable text — a real starting point, not pixel-perfect). OpenDesign writes real files into your repo — HTML/CSS, React, decks, and a portable DESIGN.md — that you own and version directly.' },
          { name: 'Is OpenDesign really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable. Google Stitch is a closed-source Google Labs product.' },
          { name: 'Is OpenDesign affiliated with Google or Stitch?', text: 'No. OpenDesign is an independent, open-source project. Google Stitch is a product of Google Labs (built on the 2025 Galileo AI acquisition); this is an unaffiliated comparison.' },
        ],
        ...
        rich: {
          heroCtaLead:
            'OpenDesign is the open-source, local-first alternative to Google Stitch — prompt-to-UI with the coding agent you already use, your key, your files, and a portable design system you keep in your repo.',
          heroCtaActions: [
            { label: 'Download OpenDesign', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          heroImage: {
            ...
            alt: 'OpenDesign vs Google Stitch — warm-paper editorial illustration of a prompt converging into a design hub you own',
          },
          intro: [
          ...
          sections: [
            ...
            {
              id: 'compare',
              heading: 'OpenDesign vs Google Stitch, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'OpenDesign', 'Google Stitch'], rows: [
            ...
            },
            {
              ...
              blocks: [
                ...
                { kind: 'steps', items: [
                  { label: 'You run out of generations', body: 'The ~350 standard generations a month, plus a much smaller experimental pool, sound generous until you are iterating on a real project. There is no paid tier and no bring-your-own-key escape hatch — so heavy days mean waiting for a reset. OpenDesign has no app-level cap; you pay your own model spend and keep going.' },
                  { label: 'The brand never sticks', body: 'Stitch has no enforceable design system: you re-prompt brand colors as hex values every time, the same prompt yields a different result each run, and navigation can drift between screens. OpenDesign centralizes brand in one DESIGN.md that every render obeys, so iterations stay consistent.' },
                  { label: 'It lives in a separate tab', body: 'Design happens in Stitch’s cloud canvas, disconnected from your repo — you export a snapshot and re-integrate by hand, with no API to wire it into CI or an agent loop. OpenDesign output lands as files in your project and is drivable from the od CLI and local HTTP daemon.' },
                  { label: 'You cannot own or fork it', body: 'Stitch is closed-source and Google-hosted: no self-host, no audit, no rebrand for your studio. OpenDesign is Apache-2.0 — fork it, run it on your own machine, embed it in pipelines, and own every artifact it produces.' },
                ] },
              ],
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/stitch/stitch-design-systems.webp', alt: 'The OpenDesign design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in OpenDesign — portable, versioned, rendered by every skill.' }, text: [
                  'OpenDesign runs a desktop app, a local daemon, and Markdown skill and design-system catalogs <b>on your machine</b>. No design output is forced through a vendor cloud, and your brand lives in your repo as a <b>portable DESIGN.md</b> file every skill respects.',
                  'You <b>bring your own agent key</b>. Credentials stay in local config or environment variables — OpenDesign never proxies them — and the API spend <b>bills directly to you</b>.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all OpenDesign comparisons</a> — including <a href="/alternatives/figma/">Figma</a> and <a href="/alternatives/lovable/">Lovable</a> — or <a href="/download/">download OpenDesign</a> to try it.' },
              ],
            },
            {
              id: 'decision',
              ...
              blocks: [
                ...
                { kind: 'p', text: 'A quick way to decide by what you actually want to do — <b>most paths point to OpenDesign</b>, but the honest exceptions are listed too:' },
                { kind: 'table', compact: true, columns: ['If you want to…', 'Best pick'], rows: [
                  ['Own your UI, code, and design system as files in git', 'OpenDesign'],
                  ['Iterate heavily without a monthly generation cap', 'OpenDesign'],
                  ['Enforce one brand (DESIGN.md) across every render', 'OpenDesign'],
                  ['Run open-source you can self-host, fork, or rebrand', 'OpenDesign'],
                  ['Drive design from your coding agent / CLI / CI (BYOK)', 'OpenDesign'],
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Google Stitch into OpenDesign',
              blocks: [
          ...
          faqTitle: 'FAQ',
          faq: [
            { name: 'What are Google Stitch’s generation limits?', text: 'Stitch’s free tier runs roughly 350 standard generations per month on Gemini 2.5 Flash, plus a smaller experimental pool on Gemini 2.5 Pro (commonly reported around 50). Reports through 2026 show the cap shifting and at times resetting daily; either way there is no paid tier to raise it and no bring-your-own-key option. OpenDesign has no app-level cap — you pay your own model API spend and keep going.' },
            { name: 'Is Google Stitch free?', text: 'Yes. Stitch is a free Google Labs experiment with no subscription, but it requires a Google account and the work lives in Google’s cloud. OpenDesign is also free and open source (Apache-2.0); you bring your own agent key, so model spend bills to you with no vendor-set cap.' },
            { name: 'Can I self-host an alternative to Google Stitch?', text: 'Stitch is cloud-only and closed-source — there is no self-host option. OpenDesign runs locally and self-hosts anywhere Node 24 runs, with full source on GitHub under Apache-2.0.' },
            { name: 'How does export compare?', text: 'Stitch exports HTML/CSS and React and supports paste-into-Figma (auto-layout, named layers, editable text — a real starting point, not pixel-perfect). OpenDesign writes real files into your repo — HTML/CSS, React, decks, and a portable DESIGN.md — that you own and version directly.' },
            { name: 'Is OpenDesign really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable. Google Stitch is a closed-source Google Labs product.' },
            { name: 'Is OpenDesign affiliated with Google or Stitch?', text: 'No. OpenDesign is an independent, open-source project. Google Stitch is a product of Google Labs (built on the 2025 Galileo AI acquisition); this is an unaffiliated comparison.' },
      ...
      'pencil-dev': {
        title: 'Best Pencil.dev alternative for design — OpenDesign',
        description:
          'Pencil (pencil.dev) is an a16z-backed, agent-driven design canvas that keeps .pen files in your repo — free in early access, but the app itself is closed-source and tuned for Claude. OpenDesign is the fully open-source (Apache-2.0), BYOK alternative: the whole app is yours, not just the file format.',
        breadcrumb: 'Best Pencil.dev alternative',
        label: 'Alternative · Pencil.dev',
        heading: 'Best Pencil.dev alternative for design.',
        lead:
          'Pencil (pencil.dev) puts an AI design canvas inside your IDE and keeps its .pen design files in your repo under Git — genuinely close to how OpenDesign works. The difference: Pencil’s app is closed-source and free only while it is in early access, and it is tuned first for Claude. OpenDesign is fully open-source (Apache-2.0) and BYOK across every major coding agent — the whole tool is yours, not just the file format.',
        tldrTitle: 'TL;DR',
        tldrBody:
        ...
        whyLead: 'Pencil and OpenDesign overlap more than most tools on this page — both are agent-driven and keep design as files in your repo. The reasons people still look for an alternative are specific:',
        reasons: [
          { label: 'The app is closed-source; only the format is “open”.', body: 'Pencil markets “open design files,” and the .pen JSON format is documented — but the application itself is a closed-source, a16z-backed product with no public source, and the format docs reserve the right to introduce breaking changes. OpenDesign is Apache-2.0: the whole app, not just the file spec, is yours to read, fork, and self-host.' },
          { label: '“Free” is early-access, not structural.', body: 'Pencil is free today but explicitly in early access — the founders say “Free is not a business model,” so paid plans and limits are on the way. OpenDesign is free because it is open source; there is no vendor that needs to meter you later, and you only ever pay your own model API spend.' },
          { label: 'Optimized for Claude, weaker elsewhere.', body: 'Pencil connects several agents over MCP but is tuned first for Claude Code, and reviewers report a weaker experience with other models. OpenDesign is BYOK and provider-neutral — Claude, Codex, Cursor, Gemini, OpenCode, or Qwen, all first-class.' },
          { label: 'UI-to-code, not a broader design surface.', body: 'Pencil is focused on turning UI into code. OpenDesign renders a wider range of artifacts from the same brand — UI, landing pages, decks, prototypes, and a portable DESIGN.md design system — all as files you own.' },
        ],
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'Both Pencil and OpenDesign are local-first — that is genuinely common ground. OpenDesign runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine, and your brand lives in your repo as a portable DESIGN.md every skill respects. Output lands as real files in your project, not state in a vendor cloud.',
          'The difference is ownership and neutrality. OpenDesign is Apache-2.0, so the whole application — not just a documented file format — is yours to fork, audit, and self-host. And you bring your own agent key: Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen, with credentials in local config and spend billed to your own provider.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        migrateTitle: 'Migration / first run',
        migrateLead: 'Pencil and OpenDesign both keep design as files in your repo, so moving over is design-first — extract your brand once and render against it:',
        migrateSteps: [
          'Install OpenDesign from the download page and bring your own agent key (Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen).',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is Pencil (pencil.dev) open source?', text: 'Not the app. Pencil is a closed-source, a16z-backed product; what is “open” is the .pen file format, which is documented but can change (the team reserves the right to make breaking changes). OpenDesign is fully open source under Apache-2.0 — the entire application, not just the file spec — and is self-hostable.' },
          { name: 'Is Pencil.dev free?', text: 'It is free today, but explicitly in early access. The founders have said “Free is not a business model,” signaling future paid plans and limits. OpenDesign is free because it is open source; you bring your own agent key, so model spend bills to you with no vendor-set cap.' },
          { name: 'What is the difference between OpenDesign and Pencil?', text: 'They are close — both are agent-driven and keep design as files in your repo under Git. The differences: OpenDesign is fully open source (Apache-2.0, not just an open format), provider-neutral BYOK (not tuned mainly for Claude), and renders a wider range of artifacts (UI, decks, prototypes, design systems). Pencil offers a more mature hands-on vector canvas and native Figma paste.' },
          { name: 'Does Pencil work with agents other than Claude?', text: 'Yes — it connects several agents over MCP (Cursor, Windsurf, Codex, and others), but it is optimized for Claude Code and reviewers report a weaker experience with other models. OpenDesign treats Claude, Codex, Cursor, Gemini, OpenCode, and Qwen as first-class.' },
          { name: 'Is OpenDesign affiliated with Pencil?', text: 'No. OpenDesign is an independent, open-source project (github.com/nexu-io/open-design, Apache-2.0). Pencil is a separate, a16z-backed product at pencil.dev; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Own the whole tool, not just the file format.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. OpenDesign is open source end to end — your UI, code, and DESIGN.md system stay in your repo from the first render onward.',
        rich: {
          heroCtaLead:
            'OpenDesign is the fully open-source, local-first alternative to Pencil — an agent-native design workspace you drive with the coding agent you already use, your key, your files, and a portable design system you keep in your repo.',
          heroCtaActions: [
            { label: 'Download OpenDesign', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          heroImage: {
            ...
            alt: 'OpenDesign vs Pencil.dev — warm-paper editorial illustration of a design canvas converging into a repo of files you own',
          },
          intro: [
            ...
            'OpenDesign is the <b>fully open-source, local-first</b> alternative: an agent-native design workspace you point <b>your own coding agent</b> at (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) over BYOK. These two are unusually close — both agent-driven, both keeping design as files in your repo. The differences are ownership and range: with OpenDesign the <b>whole app</b> is Apache-2.0 (not just a documented format), BYOK is <b>provider-neutral</b>, and the output spans UI, decks, prototypes, and a portable <b>DESIGN.md</b>. This page is honest about where Pencil genuinely wins.',
          ],
          tocLabel: 'On this page',
          toc: [
          ...
          sections: [
            ...
            {
              id: 'compare',
              heading: 'OpenDesign vs Pencil, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'OpenDesign', 'Pencil (pencil.dev)'], rows: [
                ...
                { kind: 'p', text: 'Read it honestly: Pencil wins on the <b>hands-on canvas</b> — a mature, Figma-like surface you edit directly, with native Figma paste and built-in UI kits, right inside your IDE. OpenDesign wins on <b>ownership and range</b> — the whole app is open source (not just the file format), BYOK is provider-neutral instead of Claude-first, “free” stays free because there is no vendor to monetize you, and the output spans UI, decks, prototypes, and a portable design system as files you keep.' },
              ],
            },
            {
              id: 'why-switch',
              ...
              blocks: [
                ...
                { kind: 'steps', items: [
                  { label: 'The app is closed, only the format is open', body: 'Pencil’s .pen format is documented, but the application is closed-source and a16z-backed, and the format spec reserves the right to change. OpenDesign is Apache-2.0 end to end — fork it, audit it, self-host it, and own every artifact it produces.' },
                  { label: '“Free” has an expiry date', body: 'Pencil is free while it is in early access, but the founders are explicit that “Free is not a business model.” Paid plans and limits are coming. OpenDesign is free because it is open source; you only ever pay your own model spend.' },
                  { label: 'It is Claude-first', body: 'Pencil connects several agents over MCP but is tuned for Claude Code, with a weaker experience elsewhere. OpenDesign is provider-neutral BYOK — Claude, Codex, Cursor, Gemini, OpenCode, and Qwen are all first-class.' },
                  { label: 'You want more than UI-to-code', body: 'Pencil is focused on UI → code. OpenDesign renders UI, landing pages, decks, prototypes, and a portable DESIGN.md design system from the same brand, all as files in your repo.' },
                ] },
              ],
            },
            {
              ...
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/pencil-dev/pencil-dev-design-systems.webp', alt: 'The OpenDesign design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in OpenDesign — portable, versioned, rendered by every skill.' }, text: [
                  'Both tools are local-first and keep design as files in your repo — that part is common ground. Where OpenDesign differs is that the <b>whole application</b> is Apache-2.0, not just a documented file format, so you can fork, audit, and self-host it. Your brand lives in your repo as a <b>portable DESIGN.md</b> every skill respects.',
                  'You also <b>bring your own agent key</b>, provider-neutral. Credentials stay in local config or environment variables — OpenDesign never proxies them — and the API spend <b>bills directly to you</b>, at your provider’s rates, with no vendor cap after early access.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all OpenDesign comparisons</a> — including <a href="/alternatives/figma/">Figma</a> and <a href="/alternatives/stitch/">Google Stitch</a> — or <a href="/download/">download OpenDesign</a> to try it.' },
              ],
            },
            {
              id: 'decision',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Pencil into OpenDesign',
              blocks: [
      ...
      genspark: {
        title: 'Best Genspark AI Designer alternative for design — OpenDesign',
        description:
          'Looking for a Genspark AI Designer alternative for product design? OpenDesign is an open-source, local-first design agent. Drive it with your own coding agent (BYOK) and own every file — UI, code, and design system — in your repo.',
        ...
        lead:
          'Genspark AI Designer (launched Aug 2025) is Genspark\'s one-prompt design product — strongest at graphic and marketing design: logos, posters, social graphics, packaging, whole brand systems. OpenDesign is an open-source, local-first design agent for product UI: your coding agent, your key, files you own.',
        tldrTitle: 'TL;DR',
        tldrBody:
        ...
        reasons: [
          ...
          { label: 'Own the output as files.', body: 'Genspark assets live in its cloud (AI Drive) tied to an account. OpenDesign writes UI, code and design tokens as files in your repo that you keep whether or not you keep the tool.' },
          { label: 'Open source.', body: 'Genspark is closed-source SaaS. OpenDesign is Apache-2.0 — read it, fork it, run it locally, audit what touches your designs.' },
          { label: 'BYOK over metered credits.', body: 'Genspark meters every generation in credits (and reviewers report being charged for failed or low-quality retries). OpenDesign runs on your own coding agent and key, so spend is just provider rates.' },
        ],
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'OpenDesign runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. Output lands as files in your repo, and your brand lives as a portable DESIGN.md every skill respects.',
        ...
        faq: [
          ...
          { name: 'Is OpenDesign free?', text: 'OpenDesign is free and open source (Apache-2.0). There is no subscription and no credit meter — you bring your own agent key, so model spend bills to your account at provider rates.' },
          { name: 'Is OpenDesign really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable. Genspark is closed-source.' },
          { name: 'Who owns the output each produces?', text: 'With OpenDesign you own everything — UI, code and design system are written as plain files into your own repository, no proprietary cloud format. Genspark assets live in its cloud (AI Drive) tied to your account and are exported as flattened images.' },
          { name: 'Is OpenDesign affiliated with Genspark?', text: 'No. OpenDesign is an independent, open-source project, not affiliated with Genspark or Mainfunc. This is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Designing product UI? Own it as files.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Keep Genspark for marketing graphics — bring OpenDesign in for the product.',
        rich: {
          heroCtaLead:
            'OpenDesign is the open-source, local-first alternative to Genspark for product UI — your coding agent, your key, your files, and a portable design system you keep in your repo.',
          heroCtaActions: [
            { label: 'Download OpenDesign', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          heroImage: {
            ...
            alt: 'OpenDesign vs Genspark — warm-paper editorial illustration of a prompt converging into a design hub you own',
          },
          intro: [
            ...
            'OpenDesign plays a different position, so this is an honest comparison — the two tools do <b>different jobs</b>. OpenDesign is an <b>open-source (Apache-2.0)</b>, <b>local-first</b> design agent for <b>product UI</b>: screens, flows, components and a design system, plus the code behind them. You drive it with <b>your own coding agent (BYOK)</b> and everything lands as <b>files in your repo</b>. Below we are upfront about where Genspark genuinely wins (marketing-graphic breadth, one-shot polish) and where OpenDesign wins (open source, local-first, product UI, code you own).',
          ],
          tocLabel: 'On this page',
          toc: [
          ...
          sections: [
            ...
            },
            {
              ...
              blocks: [
                ...
                { kind: 'steps', items: [
                  ...
                  { label: 'Own the output as files', body: 'Genspark assets live in its cloud (AI Drive) tied to your account and export as flattened images. OpenDesign writes UI, components and tokens as real files you commit to git and keep forever — the implication: no migration cost if you leave the tool.' },
                  { label: 'Open source you can audit', body: 'Genspark is closed-source SaaS; you cannot read, fork or self-host it. OpenDesign is Apache-2.0, so security teams can audit exactly what runs against the codebase and run it on infrastructure you control.' },
                  { label: 'BYOK over a credit meter', body: 'Genspark bills generations in credits (100/day free, then 10k–125k/mo on paid plans) and reviewers report paying for failed retries. OpenDesign runs on the coding agent and key you already have, so spend is provider rates with no per-design meter.' },
                ] },
              ],
            },
            {
              id: 'compare',
              heading: 'OpenDesign vs Genspark AI Designer, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'OpenDesign', 'Genspark AI Designer'], rows: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/genspark/genspark-design-systems.webp', alt: 'The OpenDesign design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in OpenDesign — portable, versioned, rendered by every skill.' }, text: [
                  ...
                  '<b>BYOK</b> means you supply the model. OpenDesign runs on the <b>coding agent you already use</b> (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) with <b>your own key</b>; inference bills to you at provider rates.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all OpenDesign comparisons</a> — including <a href="/alternatives/figma/">Figma</a> and <a href="/alternatives/lovable/">Lovable</a> — or <a href="/download/">download OpenDesign</a>.' },
              ],
            },
            {
              id: 'decision',
              ...
              blocks: [
                ...
                { kind: 'table', compact: true, columns: ['If you want to…', 'Best pick'], rows: [
                  ['Design product UI plus the code and a design system', 'OpenDesign'],
                  ['Own the output as editable files in your repo', 'OpenDesign'],
                  ['Run an open-source design agent you can fork and audit', 'OpenDesign'],
                  ['Keep everything local and self-hosted, no account', 'OpenDesign'],
                  ['Bring your own coding agent and model (BYOK)', 'OpenDesign'],
            ...
            {
              id: 'migrate',
              heading: 'Moving from Genspark to OpenDesign',
              blocks: [
          ...
          faq: [
            ...
            { name: 'Is OpenDesign free?', text: 'Yes — OpenDesign is free and open source (Apache-2.0), with no subscription and no credit meter. You bring your own agent key, so model spend bills to your account at provider rates.' },
            { name: 'Is OpenDesign really open source?', text: 'Yes — github.com/nexu-io/open-design under Apache-2.0, fully self-hostable. Genspark is closed-source.' },
            { name: 'Who owns the output each one produces?', text: 'With OpenDesign you own everything — UI, code and design system land as plain files in your own repository. Genspark assets live in its cloud (AI Drive) tied to your account and export as flattened images.' },
            { name: 'Is OpenDesign affiliated with Genspark?', text: 'No. OpenDesign is an independent, open-source project, not affiliated with Genspark or Mainfunc. This is an unaffiliated comparison.' },
          ],
          ctaTitle: 'Designing product UI? Own it as files.',
          ctaBody:
            'Star the repo, grab the desktop build, or run the install in your terminal. Keep Genspark for the logo and the launch poster — bring OpenDesign in for the product UI, the design system, and the code you own.',
          ctaActions: [
            { label: 'Download OpenDesign', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
      ...
      'figma-make': {
        title: 'Best Figma Make alternative for design — OpenDesign',
        description:
          'Figma Make turns prompts into React apps inside Figma\'s cloud — behind a Full seat and AI credits. OpenDesign is the open-source, local-first, BYOK alternative.',
        breadcrumb: 'Best Figma Make alternative',
        label: 'Alternative · Figma Make',
        heading: 'Best Figma Make alternative for design.',
        lead:
          'Figma Make turns a prompt — or an existing Figma frame — into a running React app, hosted inside Figma and powered by Claude Sonnet. OpenDesign is the open-source, local-first alternative: your coding agent, your key, output you own as files in your repo.',
        tldrTitle: 'TL;DR',
        tldrBody:
        ...
        reasons: [
          { label: 'The app lives in Figma\'s cloud, not your repo.', body: 'Make exports React/TSX, but the running app, its publish targets and Supabase wiring stay in Figma\'s runtime behind a Full seat. OpenDesign writes UI, code, and your design system straight into your repo.' },
          { label: 'AI usage is metered and unpredictable.', body: 'Teams burn a 3,000-credit monthly allowance in a day, mostly fixing imperfect output — and undo never refunds a credit. OpenDesign is BYOK: pay your provider directly, no credit ledger.' },
          { label: 'Authoring needs a paid Full seat.', body: 'A View or Dev seat can\'t build in Make — you need a Full seat (~$16–$90/user/mo) on top of credits. OpenDesign is Apache-2.0 and free to run.' },
          { label: 'Closed-source and cloud-only.', body: 'No self-host, no local mode, no on-premise option. OpenDesign is open source and local-first — it runs on your machine and you can audit it.' },
        ],
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          ...
          'BYOK means OpenDesign runs on the coding agent you already use (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) with your own key — you own the output and the engine driving it.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        migrateTitle: 'Migration / first run',
        migrateLead: 'Moving a Figma Make prototype toward an OpenDesign workflow:',
        migrateSteps: [
          'Install your coding agent (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) and add your own key — no Figma seat, no credits.',
          'Point OpenDesign at your repo; it runs locally and writes UI and code where your build and CI already are.',
        ...
        migrateClosing:
          'For a broader move off Figma the design tool, see the OpenDesign vs Figma comparison; this page is about Figma Make specifically.',
        faqTitle: 'FAQ',
        faq: [
          { name: 'How much does Figma Make cost?', text: 'Authoring requires a paid Figma Full seat (~$16/user/mo on Professional up to $90 on Enterprise) plus AI credits metered per action. Credit allowances run 500/mo (Starter) to 4,250/mo (Enterprise), reset monthly, no rollover; a full app generation can cost 100+ credits. OpenDesign is free to run — you only pay your own model provider via your key.' },
          { name: 'Can I self-host Figma Make or run it locally?', text: 'No. Figma Make runs exclusively inside Figma\'s hosted cloud — no local mode, self-host, or on-premise option. OpenDesign is local-first and runs entirely on your machine.' },
          { name: 'Do I need a paid Figma seat to use Figma Make?', text: 'Yes. Authoring in Make requires a paid Full seat; Dev and Collab seats get trial access only and a View seat can\'t author. OpenDesign needs no account or seat — clone the repo and run it with your own coding agent.' },
          { name: 'Can I export the code Figma Make generates?', text: 'Yes — download the React/TypeScript app as a ZIP or push it to a GitHub repo. The caveat: the export is source, not a turnkey deploy, and the running app and Supabase wiring stay tied to Figma\'s runtime. With OpenDesign the output is files in your repo from the start.' },
          { name: 'Is OpenDesign open source?', text: 'Yes — Apache-2.0, local-first, BYOK with your own coding agent (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) and your own model key. Figma Make is proprietary and closed-source.' },
          { name: 'Is OpenDesign affiliated with Figma?', text: 'No. OpenDesign is an independent, open-source project, not affiliated with or endorsed by Figma. Figma and Figma Make are trademarks of Figma, Inc.; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Own your output — from prompt to repo.',
        ctaBody:
          'Figma Make is the fastest path from a Figma frame to a hosted prototype — if you author behind a Full seat, spend AI credits, and keep the running app in Figma\'s cloud. OpenDesign takes the other path: open source, local-first, your own agent and key, every generation a file you own.',
        rich: {
          heroCtaLead:
            'OpenDesign is the open-source, local-first alternative to Figma Make — your coding agent, your key, your files, and a portable design system you keep in your repo, with no Figma cloud lock-in and no credit meter.',
          heroCtaActions: [
            { label: 'Download OpenDesign', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          heroImage: {
            ...
            alt: 'OpenDesign vs Figma Make — warm-paper editorial illustration of a prompt converging into a design hub you own',
          },
          intro: [
          ...
          sections: [
            ...
            {
              id: 'compare',
              heading: 'OpenDesign vs Figma Make, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'OpenDesign', 'Figma Make'], rows: [
            ...
            },
            {
              ...
              blocks: [
                ...
                { kind: 'steps', items: [
                  { label: 'The app lives in Figma\'s cloud, not your repo', body: 'Make can hand you a React/TSX ZIP, but the running app — its preview, publish targets, Supabase wiring — lives in Figma\'s runtime behind a Full seat. The export gives you source, not a turnkey deploy; reviewers flag excessive div nesting, thin error handling, and architecture that needs substantial rebuilding. In OpenDesign the output is the artifact — UI, components, and design system land as files in your own repo, already where your build and CI live.' },
                  { label: 'AI usage is metered, and the meter is unpredictable', body: 'The loudest complaint on Figma\'s own forum is credits: teams burn a full 3,000-credit monthly allowance in a day across ~100 prompts, and most of those go to fixing imperfect output — exactly the iteration the tool depends on. Undo reverts your file but never refunds the credit, and you can\'t predict the cap before you hit it. OpenDesign is BYOK: bring your own model key and pay your provider directly, so iteration cost is transparent and uncapped.' },
                  { label: 'Authoring is gated behind a paid Full seat', body: 'A View or Dev seat won\'t let you build in Make — you need a paid Full seat (~$16–$90/user/month) just to author, on top of credits. For a team where engineers, PMs, or contractors want to generate UI, that\'s a per-head paywall before anyone writes a prompt. OpenDesign is Apache-2.0 and free to run; anyone with a repo checkout can drive it.' },
                  { label: 'It\'s closed-source and cloud-only by design', body: 'Make runs exclusively in Figma\'s hosted cloud — there is no self-host, no local mode, and no on-premise option, a hard stop for teams with code-can\'t-leave-the-building policies or air-gapped requirements. OpenDesign is open source and local-first: it runs on your machine, your code never has to touch a third-party runtime, and you can audit exactly what the agent does.' },
                ] },
              ],
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/figma-make/figma-make-design-systems.webp', alt: 'The OpenDesign design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in OpenDesign — portable, versioned, rendered by every skill.' }, text: [
                  ...
                  '<b>BYOK</b> means you point OpenDesign at the <b>coding agent you already trust</b> (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) with <b>your own key</b>. You pick the model, pay your provider directly, and own both the output and the engine driving it — no credit meter in between.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all OpenDesign comparisons</a> — including <a href="/alternatives/figma/">Figma</a> and <a href="/alternatives/lovable/">Lovable</a> — or <a href="/download/">download OpenDesign</a>.' },
              ],
            },
            {
              ...
              blocks: [
                ...
                { kind: 'table', compact: true, columns: ['If you want…', 'Best pick'], rows: [
                  ['Output as files in your own repo, owned outright', 'OpenDesign'],
                  ['Open-source, auditable, self-hostable / local', 'OpenDesign'],
                  ['No per-seat paywall and no AI credit cap', 'OpenDesign'],
                  ['Freedom to use any model and any coding agent (BYOK)', 'OpenDesign'],
            ...
            {
              id: 'migrate',
              heading: 'Moving from Figma Make to OpenDesign',
              blocks: [
                { kind: 'p', text: 'Getting from a Figma Make prototype to an OpenDesign workflow:' },
                { kind: 'ol', items: [
                  ...
                  'Point OpenDesign at your repo; it runs locally and writes generated UI, components, and code where your build and CI already are.',
                ...
                { kind: 'p', text: 'For a broader move off Figma the design tool, see <a href="/alternatives/figma/">the OpenDesign vs Figma comparison</a>.' },
              ],
            },
          ],
          faqTitle: 'FAQ',
          ...
          ctaTitle: 'Own your output — from prompt to repo.',
          ctaBody:
            'Figma Make is the fastest path from a Figma frame to a hosted prototype — if you author behind a Full seat, spend AI credits, and keep the running app in Figma\'s cloud. OpenDesign takes the other path: open source, local-first, drive it with the coding agent and key you already have, and every generation lands as files you own in your own repo.',
          ctaActions: [
            { label: 'Download OpenDesign', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
      ...
      qoder: {
        title: 'Best QoderWork Design alternative for design — OpenDesign',
        description:
          'Looking for a QoderWork Design alternative? OpenDesign is the open-source, local-first design agent: drive it with your own coding agent, own every file it writes, no IDE or vendor lock-in.',
        ...
        lead:
          'QoderWork Design and OpenDesign agree on the big idea — design-as-code, prompt-to-UI, editable output. They diverge on everything around it: OpenDesign is open source, local-first, and runs on your own agent (BYOK); Qoder is closed-source and bound to Alibaba\'s IDE and models.',
        tldrTitle: 'TL;DR',
        tldrBody:
        ...
        reasons: [
          { label: 'You want open source.', body: 'Qoder is closed-source, built by Alibaba. OpenDesign is Apache-2.0 — read, self-host, fork, audit.' },
          { label: 'You want BYOK and agent choice.', body: 'Qoder runs its own models inside its product; OpenDesign runs on the coding agent you already use, with your keys.' },
          { label: 'You don\'t want IDE lock-in.', body: 'Qoder\'s smoothest path runs through Qoder IDE; OpenDesign works alongside whatever you already have.' },
          { label: 'You want to truly own output.', body: 'With OpenDesign the deliverable is files in your repo — committed, versioned, yours from the first keystroke.' },
        ],
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'Local-first means your design work lives where your code lives: real source — components, styles, a portable DESIGN.md every skill follows — written into your repo, versioned in git, usable even if you stop using OpenDesign.',
          'BYOK means OpenDesign ships no model and charges no inference. You point it at the agent and key you already have (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen); you choose the model and see the cost.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        migrateTitle: 'Migration / first run',
        migrateLead: 'Moving from Qoder to OpenDesign — since both speak code, your existing output is the starting point:',
        migrateSteps: [
          ...
          'Point OpenDesign at the coding agent you already use with your own key.',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'OpenDesign and Qoder look really similar — what\'s the difference?', text: 'They are close: both do prompt-to-UI, design-as-code, editable output. The difference is everything around generation. OpenDesign is open source (Apache-2.0), local-first, and BYOK with your own agent, output in your repo. Qoder is closed-source, built around Alibaba\'s models and Qoder IDE.' },
          { name: 'Is OpenDesign really open source?', text: 'Yes — Apache-2.0. Read the source, self-host, fork, audit. QoderWork Design is closed-source.' },
          { name: 'Which AI agent do I use with OpenDesign?', text: 'Whichever you already have — Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen, via BYOK with your own keys.' },
          { name: 'Does Qoder also keep my work local?', text: 'Partly — it can pin a project to a local folder and hand off to Qoder IDE. But the primary surface is a hosted canvas. In OpenDesign, the repo itself is the product.' },
          { name: 'Does OpenDesign have an interactive canvas?', text: 'No — a deliberate trade. Qoder\'s canvas with marquee-select and Nudge is excellent for visual editing. OpenDesign is code- and file-driven through your coding agent.' },
          { name: 'Is OpenDesign affiliated with Qoder or Alibaba?', text: 'No. OpenDesign is an independent, open-source project, not affiliated with Qoder or Alibaba. This is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Own your design workflow — end to end.',
        ctaBody:
          'OpenDesign runs on the coding agent you already use and writes files you actually own. No lock-in, no second subscription, no canvas you can\'t leave.',
        rich: {
          heroCtaLead:
            'OpenDesign is the open-source, local-first alternative to QoderWork Design — the same design-as-code idea, but Apache-2.0, BYOK with your own coding agent, and output that lives in your repo and belongs to you.',
          heroCtaActions: [
            { label: 'Download OpenDesign', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          heroImage: {
            ...
            alt: 'OpenDesign vs Qoder — warm-paper editorial illustration of a prompt converging into a design hub you own',
          },
          intro: [
            'Of every tool in this comparison series, QoderWork Design is the closest to OpenDesign in spirit. Built by the Qoder team at Alibaba (<a href="https://qoder.com" target="_blank" rel="noopener">qoder.com</a>), it bills itself as <b>"AI-native design as code"</b>: you describe what you want, it renders a real, runnable design on an infinite canvas, you clarify intent through <b>Questions</b>, preview a structured <b>Design Plan</b> before it builds, and then <b>Nudge</b> color, spacing and radius after the fact. The output is genuine front-end code — HTML or React on shadcn/ui, Spark Design or Ant Design — not a flattened vector mock. That is a real product with a polished loop, and it deserves the credit.',
            'Because the two tools share a thesis — prompt to UI, design as <i>code</i>, editable output you can ship — the honest comparison is not about who generates nicer screens. It is about everything <i>around</i> generation. OpenDesign is <b>Apache-2.0</b>, <b>local-first</b>, and <b>BYOK</b>: it ships no model, runs on the coding agent you already pay for, and writes its output straight into your repository. QoderWork Design is <b>closed-source</b>, runs on <b>Qoder\'s own (undisclosed) models</b> behind a credit meter, and is at its best inside Alibaba\'s own IDE. If you want the most polished integrated canvas, Qoder is excellent. If you want openness, your own agent, and a workflow that is not bet on a single vendor, that is the gap OpenDesign fills.',
          ],
          tocLabel: 'On this page',
          toc: [
          ...
          sections: [
            ...
            },
            {
              ...
              blocks: [
                ...
                { kind: 'steps', items: [
                  { label: 'You want open source', body: 'Qoder is closed-source and built by Alibaba — you cannot read how it works, self-host it, or fork it if priorities change. OpenDesign is Apache-2.0: the entire agent, skill library and renderer are on GitHub to read, audit, run on your own machine, and fork. For anyone with a security-review or supply-chain requirement, "we can read the code" is not a nice-to-have.' },
                  { label: 'You want BYOK and agent choice', body: 'QoderWork Design runs on Qoder\'s own models — which it does not publicly name — and meters them in credits you buy from Alibaba. OpenDesign ships no model and resells no inference. You point it at the coding agent and key you already pay for (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen), pick the model, and see the real cost — no second subscription, no opaque per-credit pricing.' },
                  { label: 'You don\'t want IDE or vendor lock-in', body: 'Qoder\'s smoothest path runs through the standalone Qoder IDE and the broader Alibaba ecosystem; the one-click handoff is great precisely because it assumes you live there. OpenDesign is just files in a repo, so it works alongside VS Code, JetBrains, Neovim, your CI, and your existing review process — nothing has to route through one editor.' },
                  { label: 'You want to truly own the output', body: 'In OpenDesign the deliverable is real source committed to your repository — components, styles, and a portable DESIGN.md — versioned in git and fully usable even if you stop using OpenDesign tomorrow. Qoder can pin to a local folder, but the product surface is a hosted canvas you have to stay inside; the files are a sync target downstream of it, not the source of truth.' },
                ] },
              ],
            },
            {
              id: 'compare',
              heading: 'OpenDesign vs QoderWork Design, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'OpenDesign', 'QoderWork Design'], rows: [
            ...
            },
            {
              ...
              blocks: [
                ...
                { kind: 'table', compact: true, columns: ['If you care most about…', 'Lean toward'], rows: [
                  ['Open source you can read, audit, fork, and self-host', 'OpenDesign'],
                  ['Using your own coding agent and keys (BYOK)', 'OpenDesign'],
                  ['Output that lives and stays in your own repo', 'OpenDesign'],
                  ['Freedom from any one IDE, vendor, or ecosystem', 'OpenDesign'],
                  ['No credit meter — you pay only your own agent', 'OpenDesign'],
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/qoder/qoder-design-systems.webp', alt: 'The OpenDesign design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in OpenDesign — portable, versioned, rendered by every skill.' }, text: [
                  '<b>Local-first</b> means your design work lives as <b>files in your own repo</b>: real source and a portable <b>DESIGN.md</b> that every skill obeys, versioned in git, reviewable in pull requests, and fully usable even if you stopped using OpenDesign tomorrow. QoderWork Design can pin a project to a local folder and hand it to Qoder IDE — real and useful — but the product surface is still the hosted canvas, and the local files are a sync target downstream of it. In OpenDesign the repo <i>is</i> the surface; there is no canvas you have to stay inside.',
                  '<b>BYOK</b> means OpenDesign ships no model and charges no inference. Point it at <b>your own agent and key</b> — Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — pick the model, and pay your provider directly. No credits to top up, no opaque per-task burn, and you upgrade to a better model the day it ships instead of waiting for a vendor to wire it in.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all OpenDesign comparisons</a> — including <a href="/alternatives/figma/">Figma</a>, <a href="/alternatives/lovable/">Lovable</a>, and <a href="/alternatives/v0/">v0</a> — or <a href="/download/">download OpenDesign</a>.' },
              ],
            },
            {
              id: 'migrate',
              ...
              blocks: [
                ...
                { kind: 'ol', items: [
                  ...
                  'Capture your design language — colors, spacing, radii, type scale, components — once in a portable DESIGN.md that every OpenDesign skill will follow.',
                  'Point OpenDesign at the coding agent you already use, authenticated with your own key (BYOK); nothing routes through OpenDesign\'s servers.',
          ...
          faqTitle: 'FAQ',
          faq: [
            { name: 'QoderWork Design and OpenDesign both do design-as-code — how are they actually different?', text: 'They are the closest peers in this comparison: both turn a prompt into runnable, editable UI code rather than a flattened mock. The difference is everything around generation. OpenDesign is open source (Apache-2.0), local-first, and BYOK — it runs on the coding agent you already pay for and writes output straight into your repo. QoderWork Design is closed-source, runs on Qoder\'s own undisclosed models behind a credit meter, and is at its best inside Alibaba\'s Qoder IDE. Same idea; opposite stances on openness and ownership.' },
            { name: 'Is OpenDesign really open source?', text: 'Yes — Apache-2.0. The whole thing — the agent, the skill and design-system library, and the renderer — is on GitHub to read, self-host, fork, and audit. QoderWork Design is closed-source.' },
            { name: 'Which AI agent and model does OpenDesign use?', text: 'Whichever you already have. OpenDesign is BYOK and ships no model of its own: Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen, with your own keys, and you choose the underlying model. QoderWork Design instead runs on Qoder\'s own models, which it does not publicly name, metered in credits.' },
            { name: 'Does QoderWork Design also keep my work local?', text: 'Partly. It can pin a project to a local folder and hand off to the Qoder IDE in one click, which is genuinely useful. But the primary working surface is a hosted canvas, so the local files are a sync target downstream of it. In OpenDesign the repo itself is the product — there is no hosted canvas in the loop.' },
            { name: 'Will my workflow be locked into Qoder IDE or the Alibaba ecosystem?', text: 'With QoderWork Design the smoothest path assumes you do — the one-click handoff lands in Qoder IDE, and the experience is tuned for the Qoder/Alibaba stack. OpenDesign has no IDE lock-in: output is just files in a repo, so it works alongside VS Code, JetBrains, Neovim, your CI, and your existing review process.' },
            { name: 'How much does each cost?', text: 'OpenDesign is free and open source; the only thing you pay for is your own coding agent (BYOK), so there is no separate seat or credit charge. Qoder is credit-based — Pro is roughly $30/month for around 2,000 credits, Pro+ about $60, and Ultra about $200, with extra credits sold per-credit; credit-heavy tasks can burn a Pro plan in days. Check qoder.com for current numbers.' },
            { name: 'Is OpenDesign affiliated with Qoder or Alibaba?', text: 'No. OpenDesign is an independent, open-source project and is not affiliated with, endorsed by, or sponsored by Qoder or Alibaba. Qoder and QoderWork are trademarks of their respective owners. This is an unaffiliated comparison.' },
          ],
          ctaTitle: 'Own your design workflow — end to end.',
          ctaBody:
            'OpenDesign runs on the coding agent you already use and writes files you actually own. No closed vendor, no credit meter, no canvas you can\'t leave.',
          ctaActions: [
            { label: 'Download OpenDesign', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
      ...
      trae: {
        title: 'Best Trae alternative for design — OpenDesign',
        description:
          'Looking for a Trae alternative for design? OpenDesign is an open-source, local-first design agent that runs on your own coding agent and keeps your design system as files you own. Many teams run both.',
        breadcrumb: 'Best Trae alternative',
        label: 'Alternative · Trae',
        heading: 'Best Trae alternative for design.',
        lead:
          'Trae is ByteDance\'s free, VS Code–based AI IDE — strong at turning screenshots and Figma frames into UI, and at SOLO full-stack generation. OpenDesign is a design-first agent that owns your design system as portable files — they sit at different layers, and many teams run both.',
        tldrTitle: 'TL;DR',
        tldrBody:
        ...
        reasons: [
          ...
          { label: 'Open source.', body: 'Trae is closed-source; OpenDesign is Apache-2.0 — read, fork, run it locally.' },
          { label: 'Agent freedom + BYOK.', body: 'Drive it with the coding agent you already use, with your own key — not one bundled model.' },
        ],
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'Local-first means the work product lives with you: a portable DESIGN.md plus the design artifacts OpenDesign generates, committed to your repo, reviewable in pull requests, yours to keep.',
          'BYOK means OpenDesign doesn\'t ship its own model. Point it at the coding agent you already trust (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) with your own key — you control the model, cost, and data path.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        migrateLead: 'For many teams the answer is both — Trae writes and ships the code, OpenDesign owns the design system that feeds it:',
        migrateSteps: [
          'Keep Trae as your IDE for writing, refactoring, and shipping code (including SOLO and design-to-code).',
          'Add OpenDesign as your design layer; point it at your coding agent with your own key.',
          'Make DESIGN.md the source of truth — every OpenDesign skill follows it.',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Isn\'t Trae an IDE? What\'s its relationship to OpenDesign?', text: 'Yes — Trae is an AI-native IDE (a code editor forked from the VS Code core) from ByteDance, and design-to-code is a feature inside it. OpenDesign is a design-first agent that owns your design system as files. They are complementary and sit at different layers, not direct competitors.' },
          { name: 'Can I use Trae and OpenDesign together?', text: 'Yes, and many teams do. Trae writes and ships code (including SOLO and design-to-code); OpenDesign owns the design system (DESIGN.md) the code consumes. OpenDesign produces files in your repo, so any IDE — Trae included — picks them up.' },
          { name: 'Is Trae free? How does its pricing work?', text: 'Trae has a free tier (around 5,000 autocompletions/month and limited premium-model requests) plus paid tiers — as of early 2026 roughly Lite $3, Pro $10, Pro+ $30, and Ultra $100 per month — on a token-based Basic+Bonus usage model. OpenDesign is free and open-source; you pay only for your own model usage via BYOK.' },
          { name: 'Is OpenDesign open source?', text: 'Yes — Apache-2.0. Read it, fork it, self-host it, run it locally. Trae is closed-source and hosted.' },
          { name: 'Which AI agent or model does OpenDesign use?', text: 'Whichever you choose — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen, using your own key. Trae instead bundles models (Claude Sonnet, GPT-4o, Gemini 2.5 Pro, DeepSeek, and ByteDance\'s own) that you switch between in-product.' },
          { name: 'Is OpenDesign affiliated with Trae or ByteDance?', text: 'No. OpenDesign is an independent, open-source project, not affiliated with Trae or ByteDance. Trae is a ByteDance product and trademark. This is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Own your design system, on your own terms.',
        ctaBody:
          'OpenDesign is the open-source, local-first design agent that runs on the coding agent you already use — and pairs cleanly with an IDE like Trae. Keep your design system as portable files you control.',
        rich: {
          heroCtaLead:
            'OpenDesign is the open-source, local-first, design-first alternative to Trae for design — it owns your design system as portable files, runs on your own coding agent (BYOK), and pairs cleanly with the IDE you already use.',
          heroCtaActions: [
            { label: 'Download OpenDesign', href: '/download/', variant: 'primary' },
            { label: 'Star on GitHub', href: 'https://github.com/nexu-io/open-design', variant: 'ghost', external: true },
          ],
          ...
          sections: [
            ...
            {
              id: 'compare',
              heading: 'OpenDesign vs Trae, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'OpenDesign', 'Trae'], rows: [
                ...
                { kind: 'p', text: 'Where Trae wins: for several jobs it is the better pick and it is not close. It is a complete, polished AI IDE — if you want one environment to write and ship code, Trae does that and OpenDesign does not. Its design-to-code is first-class, SOLO\'s end-to-end full-stack generation has no equivalent in OpenDesign, and it is free to start. If those are your core needs, choose Trae. OpenDesign instead owns the design system as <b>files you own</b> — <b>open-source</b>, <b>local-first</b>, driven by <b>your own coding agent</b>.' },
              ],
            },
            {
              id: 'why-switch',
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'split', imageSide: 'left', image: { src: '/alternatives/trae/trae-design-systems.webp', alt: 'The OpenDesign design-system library — brands and tokens kept as files you own', caption: 'Your design system lives as files in OpenDesign — portable, versioned, rendered by every skill.' }, text: [
                  '<b>Local-first</b> means the work product lives with you, not in someone else\'s cloud. OpenDesign produces a portable <b>DESIGN.md</b> plus design artifacts directly in <b>your repository</b> — committed alongside your code, reviewable in pull requests, yours even if you stop using the tool.',
                  '<b>BYOK</b> means OpenDesign doesn\'t ship or lock you into a model. Point it at the <b>coding agent you already trust</b> (Claude Code, Codex, Cursor, Gemini, OpenCode, Qwen) with <b>your own key</b>.',
                ] },
                { kind: 'p', text: 'New to the idea? Read <a href="/blog/what-is-vibe-design/">what vibe design is</a>, browse the <a href="/plugins/">plugin and design-system library</a>, see <a href="/compare/">all OpenDesign comparisons</a> — including <a href="/alternatives/figma/">Figma</a> and <a href="/alternatives/lovable/">Lovable</a> — or <a href="/download/">download OpenDesign</a>.' },
              ],
            },
            {
              ...
              blocks: [
                ...
                { kind: 'table', compact: true, columns: ['If you want…', 'Pick'], rows: [
                  ['A design-first workflow, not a code editor', 'OpenDesign'],
                  ['To own your design system as files (DESIGN.md)', 'OpenDesign'],
                  ['Open source you can self-host and fork', 'OpenDesign'],
                  ['To bring your own coding agent and key (BYOK)', 'OpenDesign'],
                ...
                { kind: 'p', text: 'Most teams find these rows are not in conflict: Trae owns the rows about writing and shipping code, OpenDesign owns the rows about the design system itself. That is exactly why so many run both.' },
              ],
            },
            {
              id: 'migrate',
              heading: 'Using Trae and OpenDesign together',
              blocks: [
                { kind: 'p', text: 'A common setup runs both — Trae as the IDE, OpenDesign as the design layer:' },
                { kind: 'ol', items: [
                  'Keep Trae for writing, refactoring, and shipping code (including SOLO and design-to-code).',
                  'Add OpenDesign; point it at the coding agent you already use with your own key.',
                  'Make DESIGN.md the source of truth — every OpenDesign skill follows it.',
                  'Loop them: reconcile Trae\'s UI against your design system; commit design-system changes as files Trae picks up.',
                ] },
      ...
      'claude-design': {
        title: 'Open-source Claude Design alternative — OpenDesign (BYOK, local-first)',
        description:
          'OpenDesign is the open-source, local-first alternative to Claude Design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — your skills and DESIGN.md live in your repo.',
        breadcrumb: 'Open-source Claude Design alternative',
        label: 'Alternative · Claude Design',
        heading: 'Open-source Claude Design alternative.',
        lead:
          'OpenDesign is the open-source, local-first alternative to Claude Design. Same use case — prompt to design artifact — different posture: BYOK with the agent you already use, keep your brand as a portable DESIGN.md file, and ship artifacts as files in your project.',
        tldrTitle: 'TL;DR',
        tldrBody:
        ...
        faq: [
          { name: 'Is OpenDesign really a drop-in alternative to Claude Design?', text: 'Not literally, but they overlap on prompt-to-design-artifact use cases.' },
          { name: 'Can I use Claude as my agent in OpenDesign?', text: 'Yes. OpenDesign supports Claude Code and Anthropic API BYOK flows; credentials are never proxied through us.' },
          { name: 'What happens to my Claude Design designs?', text: 'You can keep using Claude Design alongside OpenDesign; migration is manual today.' },
          { name: 'Does OpenDesign generate the same artifact types?', text: 'Yes for common types: landing pages, decks, dashboards, social posts, brand systems, and prototypes.' },
          { name: 'Is OpenDesign really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is OpenDesign affiliated with Anthropic or Claude?', text: 'No. OpenDesign is an independent, open-source project. Claude is a trademark of Anthropic; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Switch in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'OpenDesign vs Claude Design — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Claude Design is a hosted, vendor-managed product for prompt-to-design work. OpenDesign is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — that keeps your skills and a portable brand as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'OpenDesign is a different posture: a local-first, open-source design agent you point your own coding agent at — overlapping on the prompt-to-design-artifact job, not on being a hosted product.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'p', text: 'OpenDesign runs a desktop app, a local daemon, and Markdown skill/system catalogs on your machine. No design output is forced through a vendor cloud, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — OpenDesign never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'OpenDesign vs Claude Design, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'OpenDesign', 'Claude Design'], rows: [
                  ['License', 'Apache-2.0, full source on GitHub', 'Closed-source, hosted product'],
                  ['Runtime', 'Local daemon on your machine', 'Vendor cloud'],
                ...
                { kind: 'p', text: 'Where Claude Design wins: zero local setup, one vendor bill, and a hosted UI. If that convenience is the priority, a hosted product is hard to beat — OpenDesign trades it for ownership, BYOK, and open source.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Claude Design into OpenDesign',
              blocks: [
          ...
          faq: [
            { name: 'Is OpenDesign really a drop-in alternative to Claude Design?', text: 'Not literally, but they overlap on prompt-to-design-artifact use cases.' },
            { name: 'Is Claude Design free?', text: 'Claude Design is a paid hosted product. OpenDesign is free and open source (Apache-2.0) — you only pay for your own agent API usage (BYOK), with nothing bundled into a subscription.' },
            { name: 'Is there a free Claude Design alternative?', text: 'Yes — OpenDesign is a free, open-source (Apache-2.0) alternative. Download the desktop app, bring your own agent key, and design locally with no seat or subscription fee.' },
            { name: 'Does Claude Design have templates — and does OpenDesign?', text: 'OpenDesign ships composable SKILL.md skills and portable DESIGN.md design systems you can fork, instead of fixed built-in templates — so a template becomes a file you own and version in your repo.' },
            { name: 'Is Claude Design open source or on GitHub?', text: 'Claude Design is a closed-source hosted product. If you want an open-source design tool you can read, fork, self-host, or download, OpenDesign is on GitHub at github.com/nexu-io/open-design under Apache-2.0.' },
            { name: 'Can I use Claude as my agent in OpenDesign?', text: 'Yes. OpenDesign supports Claude Code and Anthropic API BYOK flows; credentials are never proxied through us.' },
            { name: 'What happens to my Claude Design designs?', text: 'You can keep using Claude Design alongside OpenDesign; migration is manual today.' },
            { name: 'Does OpenDesign generate the same artifact types?', text: 'Yes for common types: landing pages, decks, dashboards, social posts, brand systems, and prototypes.' },
            { name: 'Is OpenDesign really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
    ...
    download: {
      ...
      heroVisualAlt:
        'OpenDesign desktop workspace creating a website with a local agent and a curated design system.',
      mobileDesktopNotice: 'OpenDesign is a desktop app. Please open this page on a computer to download.',
      autoCtaPrefix: 'Download free for',
      autoCtaFallback: 'Download OpenDesign free',
      ...
      ctaBody:
        'Install from source in three commands, or drive OpenDesign headlessly from your existing coding agent.',
    },
  },
};
...
const COMPACT_DOWNLOAD_COPY: Partial<Record<LandingLocaleCode, DownloadCopy>> = {
  ja: {
    ...
    heroVisualAlt:
      'ローカルエージェントと厳選されたデザインシステムを使って Web サイトを作成する OpenDesign のデスクトップワークスペース。',
    autoCtaPrefix: '無料ダウンロード:',
    autoCtaFallback: 'OpenDesign を無料でダウンロード',
    recommended: 'おすすめ',
    publishedPrefix: '公開日',
    ...
    ctaTitle: 'ターミナル派ですか？',
    ctaBody:
      '3 つのコマンドでソースからインストール、または既存のコーディングエージェントから OpenDesign をヘッドレスで動かせます。',
  },
  ko: {
    ...INFO_PAGE_COPY.en!.download,
    ...
    heroVisualAlt:
      '로컬 에이전트와 엄선된 디자인 시스템으로 웹사이트를 만드는 OpenDesign 데스크톱 워크스페이스.',
    autoCtaPrefix: '무료 다운로드:',
    autoCtaFallback: 'OpenDesign 무료 다운로드',
    recommended: '추천',
    publishedPrefix: '출시일',
    releaseNotes: '릴리스 노트',
    ...
    ctaBody:
      '세 개의 명령으로 소스에서 설치하거나, 기존 코딩 에이전트에서 OpenDesign을 헤드리스로 구동하세요.',
  },
  de: {
    ...INFO_PAGE_COPY.en!.download,
    ...
    heroVisualAlt:
      'Der OpenDesign Desktop-Workspace erstellt mit einem lokalen Agenten und einem kuratierten Design-System eine Website.',
    autoCtaPrefix: 'Kostenlos herunterladen für',
    autoCtaFallback: 'OpenDesign kostenlos herunterladen',
    ...
    ctaBody:
      'Installiere aus dem Quellcode mit drei Befehlen oder steuere OpenDesign headless aus deinem bestehenden Coding-Agent.',
  },
  fr: {
    ...INFO_PAGE_COPY.en!.download,
    ...
    heroVisualAlt:
      'L’espace de travail desktop OpenDesign crée un site avec un agent local et un système de design sélectionné.',
    autoCtaPrefix: 'Télécharger gratuitement pour',
    autoCtaFallback: 'Télécharger OpenDesign gratuitement',
    ...
    ctaBody:
      'Installez depuis les sources en trois commandes, ou pilotez OpenDesign en mode headless depuis votre agent de code existant.',
  },
  ru: {
    ...INFO_PAGE_COPY.en!.download,
    ...
    heroVisualAlt:
      'Десктопное рабочее пространство OpenDesign создаёт сайт с помощью локального агента и тщательно отобранной дизайн-системы.',
    autoCtaPrefix: 'Скачать бесплатно для',
    autoCtaFallback: 'Скачать OpenDesign бесплатно',
    ...
    ctaBody:
      'Установите из исходников тремя командами или управляйте OpenDesign в headless-режиме из вашего существующего агента для кода.',
  },
  es: {
    ...INFO_PAGE_COPY.en!.download,
    ...
    heroVisualAlt:
      'El espacio de trabajo de escritorio de OpenDesign crea un sitio web con un agente local y un sistema de diseño seleccionado.',
    autoCtaPrefix: 'Descarga gratis para',
    autoCtaFallback: 'Descarga OpenDesign gratis',
    ...
    ctaBody:
      'Instala desde el código fuente con tres comandos, o controla OpenDesign en modo headless desde tu agente de código actual.',
  },
  'pt-br': {
    ...INFO_PAGE_COPY.en!.download,
    ...
    heroVisualAlt:
      'O workspace para desktop do OpenDesign cria um site com um agente local e um sistema de design selecionado.',
    autoCtaPrefix: 'Baixe grátis para',
    autoCtaFallback: 'Baixe o OpenDesign grátis',
    recommended: 'Recomendado',
    ...
    ctaBody:
      'Instale a partir do código-fonte com três comandos, ou controle o OpenDesign em modo headless pelo seu agente de código atual.',
  },
  it: {
    ...INFO_PAGE_COPY.en!.download,
    ...
    heroVisualAlt:
      'Il workspace desktop di OpenDesign crea un sito con un agente locale e un design system selezionato.',
    autoCtaPrefix: 'Scarica gratis per',
    autoCtaFallback: 'Scarica OpenDesign gratis',
    ...
    ctaBody:
      'Installa dai sorgenti con tre comandi, oppure pilota OpenDesign in modalità headless dal tuo agente di coding esistente.',
  },
  vi: {
    ...INFO_PAGE_COPY.en!.download,
    ...
    autoCtaFallback: 'Tải OpenDesign',
    ...
    ctaBody:
      'Cài đặt từ mã nguồn bằng ba lệnh, hoặc điều khiển OpenDesign ở chế độ headless từ agent lập trình hiện có của bạn.',
  },
  pl: {
    ...INFO_PAGE_COPY.en!.download,
    ...
    autoCtaFallback: 'Pobierz OpenDesign',
    ...
    ctaBody:
      'Zainstaluj ze źródeł trzema poleceniami albo steruj OpenDesign w trybie headless ze swojego agenta do kodowania.',
  },
  id: {
    ...INFO_PAGE_COPY.en!.download,
    ...
    autoCtaFallback: 'Unduh OpenDesign',
    ...
    ctaBody:
      'Pasang dari sumber dengan tiga perintah, atau jalankan OpenDesign secara headless dari agen coding Anda yang sudah ada.',
  },
  nl: {
    ...INFO_PAGE_COPY.en!.download,
    ...
    autoCtaFallback: 'OpenDesign downloaden',
    ...
    ctaBody:
      'Installeer vanuit de broncode met drie commando’s, of stuur OpenDesign headless aan vanuit je bestaande coding-agent.',
  },
  ar: {
    ...INFO_PAGE_COPY.en!.download,
    ...
    autoCtaFallback: 'تنزيل OpenDesign',
    recommended: 'موصى به',
    ...
    ctaBody:
      'ثبّت من المصدر بثلاثة أوامر، أو شغّل OpenDesign بوضع headless من وكيل البرمجة الحالي لديك.',
  },
  tr: {
    ...INFO_PAGE_COPY.en!.download,
    ...
    heroVisualAlt:
      'Yerel bir ajan ve özenle seçilmiş bir tasarım sistemiyle web sitesi oluşturan OpenDesign masaüstü çalışma alanı.',
    autoCtaPrefix: 'Ücretsiz indirin:',
    autoCtaFallback: 'OpenDesign uygulamasını ücretsiz indirin',
    ...
    ctaBody:
      'Kaynaktan üç komutla kurun veya OpenDesign’i mevcut kodlama aracınızdan headless olarak çalıştırın.',
  },
  uk: {
    ...INFO_PAGE_COPY.en!.download,
    ...
    autoCtaFallback: 'Завантажити OpenDesign',
    ...
    ctaBody:
      'Встановіть із джерел трьома командами або керуйте OpenDesign у headless-режимі з наявного агента для кодування.',
  },
};
...
INFO_PAGE_COPY.zh = {
  ...
  official: {
    ...
    title: '官方 OpenDesign —— 来源页、GitHub、发布与别名',
    description:
      'OpenDesign 官方来源页：canonical 网站、GitHub 仓库、发布、Discord、许可证和维护者身份都集中在这里。',
    breadcrumb: '官方',
    label: '来源 · Nº 00',
    heading: '官方 OpenDesign 来源页。',
    lead:
      'OpenDesign（也会被搜索为 Open Design、open-design、opendesign 或 Open Design AI）是 nexu-io/open-design 项目的官方开源 AI 设计工作台。这个页面列出所有 canonical 入口，方便你自行核验来源。',
    ...
    aliases: [
      { label: 'OpenDesign', body: '产品 UI、博客和 README 中统一的连写展示名。' },
      { label: 'Open Design', body: '旧的带空格写法，仍是常见搜索变体，指向同一个项目。' },
    ...
    maintainerBody:
      'OpenDesign 在 github.com/nexu-io/open-design 公开开发，并以 Apache-2.0 发布。Issue、RFC 和路线图讨论都在 GitHub Issues 与 Discord 进行。',
  ...
  quickstart: {
    ...
    title: 'OpenDesign 快速开始 —— 三条命令安装（Node 24、pnpm）',
    description:
      '用三条命令在本地安装 OpenDesign。包含 Node 24、pnpm 10.33.2 要求、命令、预期输出、排障和首次生成设计 artifact 的步骤。',
    breadcrumb: '快速开始',
    label: '安装 · Nº 01',
    heading: 'OpenDesign 快速开始。',
    lead: 'OpenDesign 完全运行在你的机器上。三条命令就能从干净 checkout 到本地 daemon、Web UI 和第一个设计 artifact。',
    ...
    nextItems: [
      ...
      { label: '比较 OpenDesign', body: '了解它和 Claude Design、Figma Make、v0、Lovable 的差异。' },
  ...
  agents: {
    ...
    title: 'OpenDesign Agent —— {count} 个 BYOK 适配器',
    description: 'OpenDesign 内置 {count} 个 BYOK 适配器。直接用你写代码时已经在用的 Agent 来驱动设计，无需额外厂商登录。',
    breadcrumb: 'Agent',
    label: '适配器 · Nº 04',
    heading: (count) => `${count} 个 BYOK Agent，一套 Skill 协议。`,
    lead: (count) =>
      `OpenDesign 内置 ${count} 个一方适配器。同一套可组合 Skill 和可移植 DESIGN.md 系统可以用于每一个 Agent。全程 BYOK：你的密钥、你的成本、你的数据。`,
    adaptersTitle: '适配器如何接入',
    adaptersBody:
      '每个适配器都是很薄的一层 shim，把 Agent 原生消息格式翻译成 OpenDesign Skill 协议。新增适配器通常只是一个文件，不需要 fork 整个产品。',
    tiers: [
      { label: 'Tier 1 —— 一方日常验证', blurb: 'OpenDesign 维护者每天使用的适配器。支持时会使用 Stream-JSON IPC、AskUserQuestion 中途交互和 Skill-aware system prompt。' },
    ...
    byokLead: 'OpenDesign 中的 BYOK（bring your own key）意味着凭据和成本都留在你这一侧：',
    byokItems: [
    ...
    ctaBody: '选择你电脑上已有的 Agent，把 OpenDesign 指向它，然后开始渲染。',
  },
  compare: {
    ...INFO_PAGE_COPY.en!.compare,
    title: 'OpenDesign vs Claude Design、Figma Make、v0、Lovable —— 诚实对比',
    description:
      '比较 OpenDesign 与主流 AI 设计工具：云端托管 vs 本地优先、BYOK vs 厂商锁定、一次性生成 vs 可移植 DESIGN.md 系统。',
    breadcrumb: '对比',
    label: '评估 · Nº 02',
    heading: 'OpenDesign 与其它工具的对比。',
    lead: '这里用简短、诚实的摘要说明 OpenDesign 与你可能正在评估的其它 AI 设计工具之间的关系。',
    toc: ['vs Claude Design', 'vs Figma Make', 'vs v0', 'vs Lovable / Bolt', 'vs Open CoDesign', '真实限制'],
    comparisons: [
      { competitor: 'Claude Design', summary: '绑定单一厂商的云端产品。OpenDesign 本地优先、BYOK、Apache-2.0，Skill 与 DESIGN.md 都留在你的 repo。', cta: '阅读完整对比 ->' },
      { competitor: 'Figma Make', summary: 'Figma Make 侧重在 Figma 内 prompt-to-mockup。OpenDesign 把可移植 artifact 直接交付到你的项目。', cta: '查看仓库中的迁移说明 ->' },
      { competitor: 'v0 by Vercel', summary: 'v0 在云端 runtime 生成 React 组件。OpenDesign 在本地生成 deck、dashboard、landing page 和品牌系统。', cta: '查看仓库中的迁移说明 ->' },
      { competitor: 'Lovable / Bolt', summary: 'Lovable 和 Bolt 侧重云端 prompt-to-app。OpenDesign 是给你已有 Agent 使用的设计 Skill 层。', cta: '查看仓库中的迁移说明 ->' },
      { competitor: 'Open CoDesign', summary: 'Open CoDesign 是同领域开源项目。OpenDesign 可以通过 Skill 协议包装 codesign 类型工作流。', cta: '查看仓库中的迁移说明 ->' },
    ],
    limitsTitle: '真实限制 —— OpenDesign 不是什么',
    limitsBody: 'OpenDesign 不试图成为所有云端 AI 设计工具。下面的问题说明实际取舍，而不是把限制包装掉。',
    limitsFaq: [
      { name: 'OpenDesign 有云端 Web sandbox 吗？', text: '没有。OpenDesign 的设计目标就是本地优先。' },
      { name: '不安装任何东西可以使用 OpenDesign 吗？', text: '目前不行。最小形态是本地 daemon 加一个 coding agent。' },
      { name: 'OpenDesign 是 v0 / Lovable / Bolt 替代品吗？', text: '取决于场景。OpenDesign 聚焦通过可 fork 的 Skill 协议生成设计 artifact。' },
      { name: 'OpenDesign 会把我的数据发给 Anthropic、OpenAI 或 Google 吗？', text: '只会把 prompt 与 Skill 上下文发给你自己带 key 的 provider。' },
      { name: '可以把 OpenDesign 自托管到自己的基础设施吗？', text: '可以。Apache-2.0、Node 24 daemon、没有必需 SaaS。' },
    ],
  },
  claudeAlternative: {
    ...INFO_PAGE_COPY.en!.claudeAlternative,
    title: 'Claude Design 开源替代方案 —— OpenDesign（BYOK、本地优先）',
    description:
      'OpenDesign 是 Claude Design 的开源、本地优先替代方案。支持 Claude Code、Codex、Cursor、Gemini、OpenCode 或 Qwen 的 BYOK 工作流。',
    breadcrumb: 'Claude Design 开源替代方案',
    label: '替代方案 · Nº 03',
    heading: 'Claude Design 的开源替代方案。',
    lead:
      'OpenDesign 是官方开源、本地优先的 Claude Design 替代方案。你可以用自己已有的 Agent BYOK，把品牌保存为可移植 DESIGN.md 文件，并把 artifact 作为项目文件交付。',
    tldrTitle: '简版结论',
    ...
    localByokBody: [
      'OpenDesign 在你的机器上运行桌面应用、本地 daemon，以及 Markdown 形式的 Skill/System 目录。',
    ...
    pickOpenTitle: '适合 OpenDesign 的情况',
    ...
    migrateSteps: ['按快速开始安装 OpenDesign。', '打开 Web UI，让 Agent 查看一个你喜欢的 Claude Design artifact。', '让 Agent 把品牌提取成 DESIGN.md 文件。', '选择一个 Skill，用新品牌渲染。'],
    migrateClosing: '之后每个 Skill 都能沿用你的品牌，不需要反复重新提示。',
    faqTitle: 'FAQ',
    faq: [
      { name: 'OpenDesign 真的是 Claude Design 的 drop-in 替代吗？', text: '不是字面上的 drop-in，但它们都覆盖 prompt-to-design-artifact 这个用途。' },
      { name: '可以在 OpenDesign 中使用 Claude 作为 Agent 吗？', text: '可以。OpenDesign 支持 Claude Code 和 Anthropic API BYOK。' },
      { name: '我的 Claude Design 设计怎么办？', text: '你可以继续并行使用 Claude Design；目前迁移是手动的。' },
      { name: 'OpenDesign 能生成相同类型的 artifact 吗？', text: '常见类型可以：落地页、演示文稿、仪表盘、社交内容、品牌系统和原型。' },
      { name: '为什么说 open-source Claude Design，而不是 open-source AI design tool？', text: '因为很多用户就是用这个形状来描述他们在找的产品。' },
      { name: '谁在构建和维护 OpenDesign？', text: '项目位于 github.com/nexu-io/open-design，许可证为 Apache-2.0。' },
    ],
    ctaTitle: '三条命令切换。',
  ...
  download: {
    ...
    heroVisualAlt: 'OpenDesign 桌面工作区使用本地 Agent 和精选设计系统创建网站。',
    mobileDesktopNotice: 'OpenDesign 是桌面客户端，请在电脑上下载。',
    autoCtaPrefix: '免费下载',
    autoCtaFallback: '免费下载 OpenDesign',
    recommended: '推荐',
    publishedPrefix: '发布于',
    releaseNotes: '更新日志',
    platformsTitle: '全部平台',
    ...
    ctaTitle: '更喜欢用终端？',
    ctaBody: '三条命令从源码安装，或用你现有的编码 agent 以 headless 方式驱动 OpenDesign。',
  },
};
...
INFO_PAGE_COPY['zh-tw'] = {
  ...
  official: {
    ...
    title: '官方 OpenDesign —— 來源頁、GitHub、發布與別名',
    description:
      'OpenDesign 官方來源頁：canonical 網站、GitHub repo、發布、Discord、授權與維護者身份都集中在這裡。',
    breadcrumb: '官方',
    heading: '官方 OpenDesign 來源頁。',
    lead:
      'OpenDesign（也會被搜尋為 Open Design、open-design、opendesign 或 Open Design AI）是 nexu-io/open-design 專案的官方開源 AI 設計工作台。這個頁面列出所有 canonical 入口，方便你自行核驗來源。',
    canonicalBody: '請收藏 open-design.ai 與 GitHub repo。其他入口都應回到這兩個來源之一。',
    aliasesTitle: '命名與別名',
    aliasesLead: '不同工具、受眾與語言環境裡，這個專案會以幾種方式被搜尋和書寫：',
    aliases: [
      { label: 'OpenDesign', body: '產品 UI、部落格與 README 中統一的連寫展示名。' },
      { label: 'Open Design', body: '舊的帶空格寫法，仍是常見搜尋變體，指向同一個專案。' },
    ...
    maintainerBody:
      'OpenDesign 在 github.com/nexu-io/open-design 公開開發，並以 Apache-2.0 發布。Issue、RFC 與路線圖討論都在 GitHub Issues 與 Discord 進行。',
  ...
  quickstart: {
    ...
    title: 'OpenDesign 快速開始 —— 三條命令安裝（Node 24、pnpm）',
    description:
      '用三條命令在本地安裝 OpenDesign。包含 Node 24、pnpm 10.33.2 要求、命令、預期輸出、排障與首次生成設計 artifact 的步驟。',
    breadcrumb: '快速開始',
    heading: 'OpenDesign 快速開始。',
    lead: 'OpenDesign 完全執行在你的機器上。三條命令就能從乾淨 checkout 到本地 daemon、Web UI 和第一個設計 artifact。',
  ...
  agents: {
    ...
    title: 'OpenDesign Agent —— {count} 個 BYOK adapter',
    description: 'OpenDesign 內建 {count} 個 BYOK adapter。直接用你寫程式時已經在用的 Agent 來驅動設計，無需額外供應商登入。',
    breadcrumb: 'Agent',
    heading: (count) => `${count} 個 BYOK Agent，一套 Skill 協議。`,
    lead: (count) =>
      `OpenDesign 內建 ${count} 個一方 adapter。同一套可組合 Skill 與可移植 DESIGN.md 系統可以用於每一個 Agent。全程 BYOK：你的密鑰、你的成本、你的資料。`,
    adaptersTitle: 'Adapter 如何接入',
    adaptersBody:
      '每個 adapter 都是很薄的一層 shim，把 Agent 原生訊息格式翻譯成 OpenDesign Skill 協議。新增 adapter 通常只是一個檔案，不需要 fork 整個產品。',
    vendor: '供應商',
    credential: '憑據',
    byokTitle: '這裡的 BYOK 是什麼意思',
    byokLead: 'OpenDesign 中的 BYOK（bring your own key）意味著憑據和成本都留在你這一側：',
    byokItems: [
    ...
    ctaBody: '選擇你電腦上已有的 Agent，把 OpenDesign 指向它，然後開始渲染。',
  },
  compare: {
    ...INFO_PAGE_COPY.zh!.compare,
    title: 'OpenDesign vs Claude Design、Figma Make、v0、Lovable —— 誠實比較',
    breadcrumb: '比較',
    label: '評估 · Nº 02',
    heading: 'OpenDesign 與其他工具的比較。',
    lead: '這裡用簡短、誠實的摘要說明 OpenDesign 與你可能正在評估的其他 AI 設計工具之間的關係。',
    limitsTitle: '真實限制 —— OpenDesign 不是什麼',
    limitsBody: 'OpenDesign 不試圖成為所有雲端 AI 設計工具。下面的問題說明實際取捨，而不是把限制包裝掉。',
  },
  claudeAlternative: {
    ...INFO_PAGE_COPY.zh!.claudeAlternative,
    title: 'Claude Design 開源替代方案 —— OpenDesign（BYOK、本地優先）',
    description:
      'OpenDesign 是 Claude Design 的開源、本地優先替代方案。支援 Claude Code、Codex、Cursor、Gemini、OpenCode 或 Qwen 的 BYOK 工作流。',
    breadcrumb: 'Claude Design 開源替代方案',
    label: '替代方案 · Nº 03',
    heading: 'Claude Design 的開源替代方案。',
    lead:
      'OpenDesign 是官方開源、本地優先的 Claude Design 替代方案。你可以用自己已有的 Agent BYOK，把品牌保存為可移植 DESIGN.md 檔案，並把 artifact 作為專案檔案交付。',
    tldrTitle: '簡版結論',
    ...
    pickOpenTitle: '適合 OpenDesign 的情況',
    migrateTitle: '遷移 / 首次執行',
    faqTitle: 'FAQ',
    faq: [
      { name: 'OpenDesign 真的是 Claude Design 的 drop-in 替代嗎？', text: '不是字面上的 drop-in，但它們都覆蓋 prompt-to-design-artifact 這個用途。' },
      { name: '可以在 OpenDesign 中使用 Claude 作為 Agent 嗎？', text: '可以。OpenDesign 支援 Claude Code 和 Anthropic API BYOK。' },
      { name: '我的 Claude Design 設計怎麼辦？', text: '你可以繼續並行使用 Claude Design；目前遷移是手動的。' },
      { name: 'OpenDesign 能生成相同類型的 artifact 嗎？', text: '常見類型可以：落地頁、簡報、儀表板、社群內容、品牌系統和原型。' },
      { name: '為什麼說 open-source Claude Design，而不是 open-source AI design tool？', text: '因為很多使用者就是用這個形狀來描述他們在找的產品。' },
      { name: '誰在構建和維護 OpenDesign？', text: '專案位於 github.com/nexu-io/open-design，授權為 Apache-2.0。' },
    ],
    ctaTitle: '三條命令切換。',
...
> = {
  ja: {
    ...
    reusable: {
      sourceBody: 'この項目は OpenDesign の正規の入口と同じプロジェクトを指します。',
    ...
    official: {
      title: '公式 OpenDesign — 出典、GitHub、リリース、別名',
      description: 'OpenDesign の正規ページ、GitHub、リリース、コミュニティ、ライセンスをまとめた確認用ページです。',
      breadcrumb: '公式',
      label: '出典 · Nº 00',
      heading: '公式 OpenDesign 出典ページ。',
      lead: 'OpenDesign は nexu-io/open-design プロジェクトのオープンソース AI デザインワークスペースです。',
    },
    quickstart: {
      title: 'OpenDesign クイックスタート — Node 24 と pnpm で開始',
      description: 'OpenDesign をローカルに入れ、daemon、Web UI、最初の artifact まで進む手順です。',
      breadcrumb: 'クイックスタート',
      label: 'インストール · Nº 01',
      heading: 'OpenDesign クイックスタート。',
      lead: 'ローカル環境だけで起動し、既存のエージェントからデザイン生成を始められます。',
      ctaTitle: 'ローカルで始める。',
    },
    agents: {
      title: 'OpenDesign エージェント — {count} 個の BYOK アダプター',
      description: '普段使っているコーディングエージェントから OpenDesign のスキルを実行できます。',
      breadcrumb: 'エージェント',
      label: 'アダプター · Nº 04',
      heading: '{count} 個の BYOK エージェント、1 つのスキルプロトコル。',
      lead: 'OpenDesign は {count} 個のアダプターで、同じスキルと DESIGN.md を複数のエージェントから使えます。',
      ctaTitle: '{count} 個のアダプター。あなたのエージェント。',
    },
    compare: {
      title: 'OpenDesign と主要 AI デザインツールの比較',
      description: 'ローカル優先、BYOK、オープンソース、ポータブルな DESIGN.md という観点で比較します。',
      breadcrumb: '比較',
      label: '評価 · Nº 02',
      heading: 'OpenDesign と他の選択肢。',
      lead: 'OpenDesign はホスト型ツールではなく、エージェントで動かすローカル優先のデザイン層です。',
    },
    claudeAlternative: {
      title: 'Claude Design のオープンソース代替 — OpenDesign',
      description: 'OpenDesign は BYOK とローカル優先を軸にした Claude Design 代替です。',
...
function compactInfoTextFromHome(locale: LandingLocaleCode): CompactInfoPageText {
  ...
  return {
    ...
    official: {
      title: `${labels.official} · OpenDesign`,
      description: summary,
      breadcrumb: labels.official,
      label: labels.official,
      heading: `${labels.official} · OpenDesign`,
      lead,
    },
    quickstart: {
      title: `${labels.quickstart} · OpenDesign`,
      description: lead,
      breadcrumb: labels.quickstart,
      label: labels.quickstart,
      heading: `${labels.quickstart} · OpenDesign`,
      lead,
      ctaTitle: labels.next,
    },
    agents: {
      title: `${labels.agents} · OpenDesign`,
      description: lead,
    ...
    compare: {
      title: `${labels.compare} · OpenDesign`,
      description: summary,
      breadcrumb: labels.compare,
      label: labels.compare,
      heading: `${labels.compare} · OpenDesign`,
      lead,
    },
    claudeAlternative: {
      title: `${labels.alternative} · OpenDesign`,
      description: summary,
      breadcrumb: labels.alternative,
      label: labels.alternative,
      heading: `${labels.alternative} · OpenDesign`,
