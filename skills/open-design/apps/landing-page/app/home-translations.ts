...
export interface HomeExtra {
  ...
  /** Task-first H1 shown below the OpenDesign brand name. */
  ...
  stepDesc4: string;
  capTitle: string;
  labsPre: string; // before <em>OpenDesign</em>
  labsPost: string; // after <em>OpenDesign</em> (incl. punctuation)
  // Lead paragraph under the "What can you make with OpenDesign?" heading.
...
const en: HomeExtra = {
  ...
  labsPost: '?',
  labsLead:
    'Prototypes, landing pages, slide decks, dashboards, brand and design systems — even HTML video. OpenDesign turns each into real, runnable files, driven by your own coding agent and ready to ship or hand off to engineering.',
  ...
  testiPost: 'are building OpenDesign together',
  newsTitle: 'The OpenDesign newsletter',
  newsDesc:
  ...
  faqTitle: 'OpenDesign FAQ — open source, local-first, and Claude Design alternative',
  footProduct: 'Product',
...
const zh: HomeExtra = {
  ...
  labsPost: ' 能产出什么？',
  labsLead:
    '原型、落地页、演示文稿、数据看板、品牌与设计系统，甚至 HTML 视频。OpenDesign 会把它们变成真正可运行的文件，由你自己的编程助手驱动，随时可以交付或交接给工程团队。',
  methodTitle: '连接 21+ 款编程助手，开箱即用',
  ctaTitle: '让最前沿的 AI 设计能力回到每一个创作者的桌上',
  testiPre: '来自全球，',
  testiMid: ' 贡献者',
  testiPost: '正在一起构建 OpenDesign',
  newsTitle: 'OpenDesign 订阅',
  newsDesc: '新模板、设计系统更新、大使活动与产品动态，直接发到你的邮箱。',
  newsBtn: '订阅',
  newsDone: '已收到，感谢关注！',
  newsError: '订阅失败，请稍后重试。',
  faqTitle: 'OpenDesign 常见问题 —— 开源、本地优先、Claude Design 替代',
  footProduct: '产品',
  footCommunity: '社区',
  footLegal: '法律',
  footPartners: '伙伴',
...
const zhTw: HomeExtra = {
  ...
  testiPre: '來自全球，',
  testiMid: ' 貢獻者',
  testiPost: '正在一起打造 OpenDesign',
  newsTitle: 'OpenDesign 訂閱',
...
const ja: HomeExtra = {
  ...
  labsPost: ' で何が作れる？',
  labsLead:
    'プロトタイプ、ランディングページ、スライド、ダッシュボード、ブランド／デザインシステム、さらに HTML 動画まで。OpenDesign はそれぞれを実際に動くファイルに変換し、自分のコーディングエージェントで制作して、そのまま納品や開発への引き継ぎができます。',
  methodTitle: '21+ のコーディングエージェントを設定ゼロで接続',
  ctaTitle: '最先端の AI デザイン能力を、すべての作り手の手元へ',
  testiPre: '世界中から、',
  testiMid: ' 人のコントリビューター',
  testiPost: 'が一緒に OpenDesign を作っています',
  newsTitle: 'OpenDesign ニュースレター',
  newsDesc:
    '新しいテンプレート、デザインシステムの更新、アンバサダーイベント、プロダクトの最新情報を、あなたの受信箱へ直接お届けします。',
  newsBtn: '購読する',
  newsDone: 'ご登録ありがとうございます！',
  faqTitle: 'OpenDesign のよくある質問 — オープンソース・ローカルファースト・Claude Design 代替',
  footProduct: '製品',
...
const ko: HomeExtra = {
  ...
  labsLead:
    '프로토타입, 랜딩 페이지, 슬라이드, 대시보드, 브랜드 및 디자인 시스템, 그리고 HTML 비디오까지. OpenDesign은 각각을 실제로 실행되는 파일로 만들며, 내 coding agent로 구동해 바로 배포하거나 엔지니어링에 넘길 수 있습니다.',
  methodTitle: '21개 이상의 코딩 에이전트를 설정 없이 연결',
  ctaTitle: '최첨단 AI 디자인 역량을 모든 창작자의 책상으로',
  testiPre: '전 세계에서, ',
  testiMid: '명의 기여자',
  testiPost: '가 함께 OpenDesign을 만들고 있습니다',
  newsTitle: 'OpenDesign 뉴스레터',
  newsDesc:
    '새 템플릿, 디자인 시스템 업데이트, 앰배서더 이벤트, 제품 소식을 받은편지함으로 바로 보내드립니다.',
  newsBtn: '구독',
  newsDone: '구독해 주셔서 감사합니다!',
  faqTitle: 'OpenDesign FAQ — 오픈소스, 로컬 우선, Claude Design 대안',
  footProduct: '제품',
  footCommunity: '커뮤니티',
  footLegal: '법적 고지',
  footPartners: '파트너',
...
const de: HomeExtra = {
  ...
  labsPost: ' erstellen?',
  labsLead:
    'Prototypen, Landingpages, Slides, Dashboards, Marken- und Design-Systeme – sogar HTML-Video. OpenDesign macht daraus echte, lauffähige Dateien, angetrieben von deinem eigenen Coding-Agent, bereit zum Ausliefern oder zur Übergabe an die Entwicklung.',
  ...
  testiPost: 'gemeinsam an OpenDesign',
  ...
  faqTitle: 'OpenDesign FAQ – Open Source, lokal und Claude-Design-Alternative',
  footProduct: 'Produkt',
  footCommunity: 'Community',
...
const fr: HomeExtra = {
  ...
  labsPost: ' ?',
  labsLead:
    'Prototypes, landing pages, slides, dashboards, systèmes de marque et de design — et même vidéo HTML. OpenDesign transforme chacun en fichiers réels et exécutables, pilotés par votre propre agent de code, prêts à livrer ou à transmettre à l’ingénierie.',
  ...
  testiPost: 'construisent OpenDesign ensemble',
  newsTitle: 'La newsletter OpenDesign',
  newsDesc:
  ...
  faqTitle: 'FAQ OpenDesign — open source, local-first et alternative à Claude Design',
  footProduct: 'Produit',
...
const ru: HomeExtra = {
  ...
  labsPost: '?',
  labsLead:
    'Прототипы, лендинги, слайды, дашборды, бренд- и дизайн-системы — и даже HTML-видео. OpenDesign превращает каждый в реальные рабочие файлы на вашем кодинг-агенте, готовые к сдаче или передаче разработке.',
  ...
  testiMid: ' участников',
  testiPost: 'вместе создают OpenDesign',
  newsTitle: 'Рассылка OpenDesign',
  newsDesc:
  ...
  faqTitle: 'FAQ OpenDesign — open source, локальный и альтернатива Claude Design',
  footProduct: 'Продукт',
...
const es: HomeExtra = {
  ...
  labsPost: '?',
  labsLead:
    'Prototipos, landing pages, slides, dashboards, sistemas de marca y de diseño — incluso vídeo HTML. OpenDesign convierte cada uno en archivos reales y ejecutables, impulsados por tu propio agente de código, listos para entregar o pasar a ingeniería.',
  ...
  testiPost: 'construyen OpenDesign juntos',
  newsTitle: 'La newsletter de OpenDesign',
  newsDesc:
  ...
  faqTitle: 'FAQ de OpenDesign — open source, local-first y alternativa a Claude Design',
...
const ptBr: HomeExtra = {
  ...
  labsPost: '?',
  labsLead:
    'Protótipos, landing pages, slides, dashboards, sistemas de marca e de design — até vídeo HTML. O OpenDesign transforma cada um em arquivos reais e executáveis, movidos pelo seu próprio coding agent, prontos para entregar ou repassar à engenharia.',
  ...
  testiMid: ' colaboradores',
  testiPost: 'constroem o OpenDesign juntos',
  newsTitle: 'A newsletter do OpenDesign',
  newsDesc:
  ...
  faqTitle: 'FAQ do OpenDesign — open source, local-first e alternativa ao Claude Design',
  footProduct: 'Produto',
...
const it: HomeExtra = {
  ...
  labsPost: '?',
  labsLead:
    'Prototipi, landing page, slide, dashboard, sistemi di marca e di design — persino video HTML. OpenDesign trasforma ciascuno in file reali ed eseguibili, guidati dal tuo coding agent, pronti da consegnare o passare all’ingegneria.',
  ...
  testiPost: 'costruiscono OpenDesign insieme',
  newsTitle: 'La newsletter di OpenDesign',
  newsDesc:
  ...
  faqTitle: 'FAQ di OpenDesign — open source, local-first e alternativa a Claude Design',
...
const vi: HomeExtra = {
  ...
  aboutCap2:
    'Claude Code / Codex / Cursor trên máy bạn đã đủ mạnh.\nOpenDesign kết nối chúng vào một quy trình thiết kế hoàn chỉnh.',
  ...
  testiPost: 'đang cùng xây dựng OpenDesign',
  newsTitle: 'Bản tin OpenDesign',
  newsDesc:
...
const pl: HomeExtra = {
  ...
  testiPost: 'wspólnie buduje OpenDesign',
  newsTitle: 'Newsletter OpenDesign',
  newsDesc:
...
const id: HomeExtra = {
  ...
  aboutCap2:
    'Claude Code / Codex / Cursor di mesin Anda sudah cukup kuat.\nOpenDesign menyambungkannya ke alur desain yang lengkap.',
  ...
  testiPost: 'membangun OpenDesign bersama',
  newsTitle: 'Newsletter OpenDesign',
  newsDesc:
...
const nl: HomeExtra = {
  ...
  testiMid: ' bijdragers',
  testiPost: 'samen aan OpenDesign',
  newsTitle: 'De OpenDesign-nieuwsbrief',
  newsDesc:
...
const ar: HomeExtra = {
  ...
  testiMid: ' مساهماً',
  testiPost: 'يبنون OpenDesign معاً',
  newsTitle: 'نشرة OpenDesign البريدية',
  newsDesc:
...
const tr: HomeExtra = {
  ...
  labsLead:
    'Prototipler, açılış sayfaları, slaytlar, dashboardlar, marka ve tasarım sistemleri — hatta HTML video. OpenDesign her birini kendi kodlama ajanınla çalışan gerçek, çalıştırılabilir dosyalara dönüştürür; teslime ya da mühendisliğe devretmeye hazır.',
  ...
  testiMid: ' katkıcı',
  testiPost: 'birlikte OpenDesign’ı inşa ediyor',
  newsTitle: 'OpenDesign bülteni',
  newsDesc:
  ...
  faqTitle: 'OpenDesign SSS — açık kaynak, yerel öncelikli ve Claude Design alternatifi',
  footProduct: 'Ürün',
...
const uk: HomeExtra = {
  ...
  testiMid: ' учасників',
  testiPost: 'разом будують OpenDesign',
  newsTitle: 'Розсилка OpenDesign',
  newsDesc:
