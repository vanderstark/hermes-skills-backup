...
> = {
  fr: homeFallbackCopy({
    railRight: 'OpenDesign — vol. 01 · no 26 · Apache-2.0',
    railLeft: 'Skills · systèmes · agents · BYOK · local d’abord',
    discordAria: 'Rejoindre le Discord OpenDesign',
    ...
    heroLead: (skills, systems) =>
      `OpenDesign est l’alternative officielle, local-first, à Claude Design. Votre agent de code — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — devient un moteur de design avec ${skills} skills composables et ${systems} systèmes DESIGN.md portables.`,
    ...
    officialAria: 'Source officielle OpenDesign',
    ...
    about: {
      ...
      caption: 'Études de forme · perception · imagination machinique. (OpenDesign, MMXXVI)',
    },
    capabilities: {
      rule: 'Capacités · skills · systèmes',
      surfaces: '4 surfaces / 1 boucle',
      ribbon: 'OpenDesign · MATRICE DES CAPACITÉS · OD/26',
      label: 'Capacités',
    ...
    testimonial: {
      ...
      quote: '« OpenDesign a transformé des idées IA floues en un système visuel net, crédible et réellement nouveau. »',
    ...
    cta: {
      ...
      live: 'En ligne',
      ribbon: 'OpenDesign · TERMINÉ.',
    },
  }),
  ru: homeFallbackCopy({
    railRight: 'OpenDesign — том 01 · выпуск № 26 · Apache-2.0',
    railLeft: 'Skills · системы · агенты · BYOK · local-first',
    discordAria: 'Присоединиться к Discord OpenDesign',
    ...
    heroLead: (skills, systems) =>
      `OpenDesign — официальная local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode или Qwen — становится дизайн-движком с ${skills} составными skills и ${systems} переносимыми DESIGN.md-системами.`,
    ...
    officialAria: 'Официальный источник OpenDesign',
    ...
    about: {
      ...
      caption: 'Исследования формы · восприятия · машинного воображения. (OpenDesign, MMXXVI)',
    },
    capabilities: {
      rule: 'Возможности · skills · системы',
      surfaces: '4 поверхности / 1 цикл',
      ribbon: 'OpenDesign · МАТРИЦА ВОЗМОЖНОСТЕЙ · OD/26',
      label: 'Возможности',
    ...
    testimonial: {
      ...
      label: 'Соавторы',
      quote: '«OpenDesign помог превратить расплывчатые AI-идеи в четкую, надежную и действительно новую визуальную систему.»',
    ...
    cta: {
      ...
      issue: 'Открыть issue',
      live: 'В сети',
      ribbon: 'OpenDesign · ФИНАЛ.',
    },
  }),
  es: homeFallbackCopy({
    railRight: 'OpenDesign — vol. 01 · número 26 · Apache-2.0',
    railLeft: 'Skills · sistemas · agentes · BYOK · local-first',
    discordAria: 'Unirse al Discord de OpenDesign',
    ...
    heroLead: (skills, systems) =>
      `OpenDesign es la alternativa oficial, local-first, a Claude Design. Tu agente de código — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — se convierte en un motor de diseño con ${skills} skills componibles y ${systems} sistemas DESIGN.md portables.`,
    ...
    officialAria: 'Fuente oficial de OpenDesign',
    ...
    about: {
      ...
      caption: 'Estudios de forma · percepción · imaginación maquínica. (OpenDesign, MMXXVI)',
    },
    capabilities: {
      rule: 'Capacidades · skills · sistemas',
      surfaces: '4 superficies / 1 bucle',
      ribbon: 'OpenDesign · MATRIZ DE CAPACIDADES · OD/26',
      label: 'Capacidades',
    ...
    work: {
      ...
      editedBy: 'Editado por OpenDesign',
    ...
    testimonial: {
      ...
      label: 'Colaboradores',
      quote: '«OpenDesign convirtió ideas de IA borrosas en un sistema visual nítido, creíble y realmente nuevo.»',
    ...
    cta: {
      ...
      issue: 'Abrir issue',
      live: 'En línea',
      ribbon: 'OpenDesign · CIERRE.',
    },
  }),
  'pt-br': homeFallbackCopy({
    railRight: 'OpenDesign — vol. 01 · edição nº 26 · Apache-2.0',
    railLeft: 'Skills · sistemas · agentes · BYOK · local-first',
    discordAria: 'Entrar no Discord do OpenDesign',
    ...
    heroLead: (skills, systems) =>
      `OpenDesign é a alternativa oficial, local-first, ao Claude Design. Seu agente de código — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — vira um motor de design com ${skills} skills componíveis e ${systems} sistemas DESIGN.md portáteis.`,
    ...
    officialAria: 'Fonte oficial do OpenDesign',
    ...
    about: {
      ...
      caption: 'Estudos de forma · percepção · imaginação maquínica. (OpenDesign, MMXXVI)',
    },
    capabilities: {
      rule: 'Capacidades · skills · sistemas',
    ...
    testimonial: {
      ...
      label: 'Colaboradores',
      quote: '“OpenDesign transformou ideias vagas de IA em um sistema visual nítido, confiável e realmente novo.”',
    ...
    cta: {
      ...
      issue: 'Abrir issue',
      live: 'No ar',
      ribbon: 'OpenDesign · FIM.',
    },
  }),
  it: homeFallbackCopy({
    railRight: 'OpenDesign — vol. 01 · numero 26 · Apache-2.0',
    railLeft: 'Skill · sistemi · agenti · BYOK · local-first',
    discordAria: 'Entra nel Discord di OpenDesign',
    ...
    heroLead: (skills, systems) =>
      `OpenDesign è l’alternativa ufficiale, local-first, a Claude Design. Il tuo agente di codice — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — diventa un motore di design con ${skills} skill componibili e ${systems} sistemi DESIGN.md portabili.`,
    ...
    officialAria: 'Fonte ufficiale OpenDesign',
    ...
    about: {
      ...
      caption: 'Studi di forma · percezione · immaginazione macchinica. (OpenDesign, MMXXVI)',
    },
    capabilities: {
      rule: 'Capacità · skill · sistemi',
      surfaces: '4 superfici / 1 loop',
      ribbon: 'OpenDesign · MATRICE CAPACITÀ · OD/26',
      label: 'Capacità',
    ...
    testimonial: {
      ...
      label: 'Collaboratori',
      quote: '“OpenDesign ha trasformato idee AI vaghe in un sistema visivo nitido, credibile e davvero nuovo.”',
    ...
    cta: {
      ...
      issue: 'Apri issue',
      live: 'Online',
      ribbon: 'OpenDesign · FINE.',
    },
  }),
  vi: homeFallbackCopy({
    railRight: 'OpenDesign — tập 01 · số 26 · Apache-2.0',
    railLeft: 'Skill · hệ thống · agent · BYOK · ưu tiên local',
    discordAria: 'Tham gia Discord OpenDesign',
    ...
    heroLead: (skills, systems) =>
      `OpenDesign là lựa chọn chính thức, ưu tiên local, thay Claude Design. Agent viết code bạn đang dùng — Claude Code, Codex, Cursor, Gemini, OpenCode hoặc Qwen — trở thành engine thiết kế với ${skills} skill có thể ghép và ${systems} hệ DESIGN.md di động.`,
    ...
    officialAria: 'Nguồn chính thức của OpenDesign',
    ...
    about: {
      ...
      caption: 'Nghiên cứu hình thái · tri giác · tưởng tượng máy. (OpenDesign, MMXXVI)',
    },
    capabilities: {
      rule: 'Năng lực · skill · hệ thống',
      surfaces: '4 bề mặt / 1 vòng lặp',
      ribbon: 'OpenDesign · MA TRẬN NĂNG LỰC · OD/26',
      label: 'Năng lực',
    ...
    work: {
      ...
      editedBy: 'Biên tập bởi OpenDesign',
    ...
    testimonial: {
      ...
      label: 'Cộng tác viên',
      quote: '“OpenDesign biến ý tưởng AI mơ hồ thành một hệ thị giác sắc nét, đáng tin và thật sự mới.”',
    ...
    cta: {
      ...
      issue: 'Mở issue',
      live: 'Đang chạy',
      ribbon: 'OpenDesign · KẾT.',
    },
  }),
  pl: homeFallbackCopy({
    railRight: 'OpenDesign — tom 01 · wydanie nr 26 · Apache-2.0',
    railLeft: 'Skills · systemy · agenci · BYOK · lokalnie najpierw',
    discordAria: 'Dołącz do Discorda OpenDesign',
    ...
    heroLead: (skills, systems) =>
      `OpenDesign to oficjalna, lokalna z założenia alternatywa dla Claude Design. Twój agent do kodu — Claude Code, Codex, Cursor, Gemini, OpenCode albo Qwen — staje się silnikiem designu z ${skills} kompozycyjnymi skills i ${systems} przenośnymi systemami DESIGN.md.`,
    ...
    officialAria: 'Oficjalne źródło OpenDesign',
    ...
    about: {
      ...
      caption: 'Studia formy · percepcji · wyobraźni maszynowej. (OpenDesign, MMXXVI)',
    },
    capabilities: {
      rule: 'Możliwości · skills · systemy',
      surfaces: '4 powierzchnie / 1 pętla',
      ribbon: 'OpenDesign · MACIERZ MOŻLIWOŚCI · OD/26',
      label: 'Możliwości',
    ...
    testimonial: {
      ...
      quote: '„OpenDesign zmienił niejasne idee AI w ostry, wiarygodny i naprawdę nowy system wizualny.”',
    ...
    cta: {
      ...
      issue: 'Otwórz issue',
      live: 'Online',
      ribbon: 'OpenDesign · KONIEC.',
    },
  }),
  id: homeFallbackCopy({
    railRight: 'OpenDesign — vol. 01 · edisi nº 26 · Apache-2.0',
    railLeft: 'Skill · sistem · agent · BYOK · local-first',
    discordAria: 'Bergabung ke Discord OpenDesign',
    ...
    heroLead: (skills, systems) =>
      `OpenDesign adalah alternatif resmi, local-first, untuk Claude Design. Agent coding yang sudah Anda pakai — Claude Code, Codex, Cursor, Gemini, OpenCode, atau Qwen — menjadi mesin desain dengan ${skills} skill komposable dan ${systems} sistem DESIGN.md portabel.`,
    ...
    officialAria: 'Sumber resmi OpenDesign',
    ...
    about: {
      ...
      caption: 'Studi bentuk · persepsi · imajinasi mesin. (OpenDesign, MMXXVI)',
    },
    capabilities: {
      rule: 'Kapabilitas · skill · sistem',
      surfaces: '4 permukaan / 1 loop',
      ribbon: 'OpenDesign · MATRIKS KAPABILITAS · OD/26',
      label: 'Kapabilitas',
    ...
    testimonial: {
      ...
      label: 'Kolaborator',
      quote: '“OpenDesign mengubah ide AI yang samar menjadi sistem visual yang tajam, dapat dipercaya, dan benar-benar baru.”',
    ...
    cta: {
      ...
      issue: 'Buka issue',
      live: 'Aktif',
      ribbon: 'OpenDesign · SELESAI.',
    },
  }),
  nl: homeFallbackCopy({
    railRight: 'OpenDesign — deel 01 · nummer 26 · Apache-2.0',
    railLeft: 'Skills · systemen · agents · BYOK · local-first',
    discordAria: 'Word lid van OpenDesign Discord',
    ...
    heroLead: (skills, systems) =>
      `OpenDesign is het officiële local-first alternatief voor Claude Design. Je bestaande code-agent — Claude Code, Codex, Cursor, Gemini, OpenCode of Qwen — wordt een design-engine met ${skills} combineerbare skills en ${systems} draagbare DESIGN.md-systemen.`,
    ...
    officialAria: 'Officiële bron van OpenDesign',
    ...
    about: {
      ...
      caption: 'Studies naar vorm · perceptie · machinale verbeelding. (OpenDesign, MMXXVI)',
    },
    capabilities: {
      rule: 'Mogelijkheden · skills · systemen',
      surfaces: '4 oppervlakken / 1 loop',
      ribbon: 'OpenDesign · MOGELIJKHEDENMATRIX · OD/26',
      label: 'Mogelijkheden',
    ...
    testimonial: {
      ...
      label: 'Samenwerkers',
      quote: '“OpenDesign veranderde vage AI-ideeën in een scherp, geloofwaardig en echt nieuw visueel systeem.”',
    ...
    cta: {
      ...
      issue: 'Open issue',
      live: 'Live',
      ribbon: 'OpenDesign · EINDE.',
    },
  }),
  ar: homeFallbackCopy({
    railRight: 'OpenDesign — المجلد 01 · العدد 26 · Apache-2.0',
    railLeft: 'Skills · أنظمة · Agents · BYOK · محلي أولاً',
    discordAria: 'الانضمام إلى Discord الخاص بـ OpenDesign',
    ...
    heroLead: (skills, systems) =>
      `OpenDesign هو البديل الرسمي المحلي أولاً لـ Claude Design. يتحول agent البرمجة الذي تستخدمه — Claude Code أو Codex أو Cursor أو Gemini أو OpenCode أو Qwen — إلى محرك تصميم يعتمد على ${skills} skills قابلة للتركيب و ${systems} أنظمة DESIGN.md قابلة للنقل.`,
    ...
    officialAria: 'المصدر الرسمي لـ OpenDesign',
    ...
    about: {
      ...
      caption: 'دراسات في الشكل · الإدراك · الخيال الآلي. (OpenDesign, MMXXVI)',
    },
    capabilities: {
      rule: 'القدرات · skills · الأنظمة',
      surfaces: '4 أسطح / حلقة واحدة',
      ribbon: 'OpenDesign · مصفوفة القدرات · OD/26',
      label: 'القدرات',
    ...
    testimonial: {
      ...
      label: 'المتعاونون',
      quote: '“حوّل OpenDesign أفكار AI الغامضة إلى نظام بصري حاد وموثوق وجديد فعلاً.”',
    ...
    faqSection: {
      ...
      label: 'أسئلة OpenDesign الشائعة',
    ...
    cta: {
      ...
      issue: 'افتح issue',
      live: 'مباشر',
      ribbon: 'OpenDesign · النهاية.',
    },
  }),
  tr: homeFallbackCopy({
    railRight: 'OpenDesign — cilt 01 · sayı nº 26 · Apache-2.0',
    railLeft: 'Skill · sistem · agent · BYOK · local-first',
    discordAria: 'OpenDesign Discord’a katıl',
    ...
    heroLead: (skills, systems) =>
      `OpenDesign, Claude Design’ın resmi local-first alternatifidir. Kullandığın coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode veya Qwen — ${skills} birleştirilebilir skill ve ${systems} taşınabilir DESIGN.md sistemiyle bir tasarım motoruna dönüşür.`,
    ...
    officialAria: 'OpenDesign resmi kaynağı',
    ...
    about: {
      ...
      caption: 'Form · algı · makine imgelemi çalışmaları. (OpenDesign, MMXXVI)',
    },
    capabilities: {
      rule: 'Yetenekler · skill · sistem',
      surfaces: '4 yüzey / 1 döngü',
      ribbon: 'OpenDesign · YETENEK MATRİSİ · OD/26',
      label: 'Yetenekler',
    ...
    work: {
      ...
      editedBy: 'OpenDesign editörlüğü',
    ...
    testimonial: {
      ...
      label: 'İşbirlikçiler',
      quote: '“OpenDesign belirsiz AI fikirlerini keskin, güvenilir ve gerçekten yeni bir görsel sisteme dönüştürdü.”',
    ...
    cta: {
      ...
      issue: 'Issue aç',
      live: 'Canlı',
      ribbon: 'OpenDesign · SON.',
    },
  }),
  uk: homeFallbackCopy({
    railRight: 'OpenDesign — том 01 · випуск № 26 · Apache-2.0',
    railLeft: 'Skills · системи · агенти · BYOK · local-first',
    discordAria: 'Приєднатися до Discord OpenDesign',
    ...
    heroLead: (skills, systems) =>
      `OpenDesign — офіційна local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode або Qwen — стає design engine із ${skills} composable skills та ${systems} portable DESIGN.md systems.`,
    ...
    officialAria: 'Офіційне джерело OpenDesign',
    ...
    about: {
      ...
      caption: 'Дослідження форми · сприйняття · машинної уяви. (OpenDesign, MMXXVI)',
    },
    capabilities: {
      rule: 'Можливості · skills · системи',
      surfaces: '4 поверхні / 1 цикл',
      ribbon: 'OpenDesign · МАТРИЦЯ МОЖЛИВОСТЕЙ · OD/26',
      label: 'Можливості',
    ...
    testimonial: {
      ...
      label: 'Співтворці',
      quote: '«OpenDesign допоміг перетворити нечіткі AI-ідеї на гостру, надійну й справді нову візуальну систему.»',
