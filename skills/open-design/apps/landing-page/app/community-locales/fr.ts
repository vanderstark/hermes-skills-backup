...
const fr: DeepPartial<CommunityCopy> = {
  hub: {
    title: "Communauté — OpenDesign",
    desc: "La communauté OpenDesign : des contributeurs qui livrent en public, des ambassadeurs qui animent des ateliers locaux et des modérateurs qui gardent le Discord chaleureux.",
    heroTitle: "L'open design <em>prend forme</em><br/>quand vous le livrez.",
    heroLead:
      "OpenDesign est construit par des personnes, en public. Skills, systèmes DESIGN.md, plugins, docs : chaque commit est un coup de pinceau. Choisissez une porte ci-dessous, trouvez votre salle.",
    cardMetaH: "Frappée automatiquement au premier merge",
    cardMetaS: "PNG · partagée sur X",
    cardHeroAlt:
      "Carte d'honneur d'un contributeur OpenDesign — @dev-kp-eloper, top 99,9 %, palier Giotto",
    cards: [
      {
        ord: "I",
        title: "Contributeurs",
      ...
      },
      {
        ord: "II",
        title: "Ambassadeurs",
        sub: "La <em>voix</em> d'OpenDesign dans votre ville.",
  ...
  contributors: {
    title: "Contributeurs — OpenDesign",
    desc: "Contribuez à OpenDesign : mainteneurs, classements hebdomadaires et de tous les temps, good first issues et un chemin sans code pour livrer votre première pièce.",
    heroTitle: "Les mains qui <em>livrent</em> le travail.",
    heroLead:
      "OpenDesign est construit par des personnes, en public. Skills, systèmes DESIGN.md, plugins, docs : chaque commit est un coup de pinceau. Choisissez une issue, envoyez une PR et gagnez une carte d'honneur unique dès l'instant où vous êtes mergé.",
    showcase: {
      kicker: "Tout devient un plugin",
      h2: "OpenDesign comme une scène. <em>Votre travail</em> comme le spectacle.",
      intro:
        ...
        steps: [
          {
            ...
            body: "Collez la commande ci-dessus dans l'agent au sein d'OpenDesign, ou dans celui que vous gardez déjà sous la main : Claude Code, Codex, Cursor. Il s'installe tout seul.",
          },
          {
    ...
    maintainers: {
      ...
      intro:
        "Les mainteneurs protègent la direction et la qualité d'OpenDesign : ils relisent les contributions, maintiennent la cohérence du standard et font de la place pour que davantage de contributeurs gagnent leur place dans le projet.",
      role: "Mainteneur",
      bios: {
        'Nagendhra-web':
          "Nagendhra apporte l'instinct d'un ingénieur des données pour la vérité en production : trouver la panne, mesurer le cas limite et le corriger correctement. Dans OpenDesign, cela se traduit par le travail de préparation des déploiements, le durcissement de l'empaquetage des assets et des correctifs Windows qui rendent le projet digne de confiance quand les contributeurs livrent.",
        'Sid-Qin':
          "Sid est l'ingénieur généraliste doté de l'œil d'un designer pour le détail : le genre de mainteneur qui remarque à la fois le chemin CLI cassé et l'affordance d'interaction de travers. Dans OpenDesign, Sid garde les flux d'export, les actions de plugins, les shims Windows, la gestion des MIME et la tuyauterie des agents assez nets pour qu'une communauté puisse bâtir dessus.",
      },
    },
    allTime: {
      ...
      intro:
        "Un registre au long cours de contributeurs talentueux qui continuent de transformer idées, correctifs et savoir-faire en standard OpenDesign partagé.",
    ...
    weekly: {
      ...
      intro:
        "Un instantané de contributeurs affûtés qui livrent des PR, améliorent le produit et rendent OpenDesign vivant.",
      rankLabel: "Leader de cette semaine",
      week: "7 derniers jours",
      handleSuffix: "· en tête cette semaine",
      blurbTemplate:
        "{name} donne le rythme cette semaine avec {prs} PR mergées et ce savoir-faire régulier qui fait avancer OpenDesign.",
      statRank: "Rang",
      statPrs: "PR · 7 j",
      headContributor: "Contributeur",
      headPrs: "PR",
    ...
    issues: {
      ...
      intro:
        "En direct depuis <span class=\"num\">label:&ldquo;good first issue&rdquo;</span> sur le dépôt OpenDesign. Commentez une issue pour la réclamer, et un mainteneur vous l'assignera dans la journée.",
  ...
  ambassadors: {
    title: "Ambassadeurs — OpenDesign",
    desc: "Devenez ambassadeur OpenDesign : ouvrez un atelier local, animez des rencontres et des critiques, et obtenez un budget, du matériel et un canal privé vers l'équipe centrale.",
    heroTitle: "Soyez la <em>voix</em> d'OpenDesign dans votre ville.",
    heroLead:
    ...
    program: {
      ...
      applyNote:
        "Les ambassadeurs transforment OpenDesign d'un dépôt en quelque chose que les contributeurs peuvent rencontrer dans une salle, avec de l'encre sur la table et le café refroidi.",
      cols: [
        {
          n: "I · Vocation",
    ...
    roster: {
      ...
      intro:
        "Des organisateurs locaux, des créateurs et des bâtisseurs de communauté qui aident OpenDesign à toucher davantage de designers et d'équipes.",
      places: [
  ...
  moderators: {
    title: "Modérateurs — OpenDesign",
    desc: "Rencontrez les modérateurs du Discord OpenDesign et rejoignez la salle où les designers IA-natifs livrent leur travail, ouvrent des plugins, cassent des bêtas et se débloquent mutuellement.",
      ...
      cards: [
        {
          ...
          bio: "De l'équipe fondatrice d'OpenDesign. Espère que le Discord reste un bon endroit où être. Faites signe à tout moment, sur n'importe quelle question.",
        },
        {
          role: "Gardien de la salle",
          bio: "Une main aguerrie sur Discord et dans l'animation de communauté. Garde la salle chaleureuse, les portes ouvertes, la conversation fluide. Passionné par OpenDesign.",
        },
      ],
