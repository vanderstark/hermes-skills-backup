# 🔥 OpenDesign 0.8.0-preview — Design's old world ends here. Help us build the new one.
...
→ [**Join the OpenDesign preview Discord**](https://discord.gg/mHAjSMV6gz)
