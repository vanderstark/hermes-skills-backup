...
```bash
npx skills add OctagonAI/skills --skill financial-health-scores
```
...
```bash
bunx skills add OctagonAI/skills --skill financial-health-scores
```
...
```bash
pnpm dlx skills add OctagonAI/skills --skill financial-health-scores
```
