...
```bash
npx skills add OctagonAI/skills --skill balance-sheet
```
...
```bash
bunx skills add OctagonAI/skills --skill balance-sheet
```
...
```bash
pnpm dlx skills add OctagonAI/skills --skill balance-sheet
```
